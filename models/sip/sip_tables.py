...
def gett1dataqaqc(sip_obj):
    data = {
        ...
        "Value": [
            sip_obj.chemical_name_expected,
            sip_obj.sol,
            sip_obj.ld50_m,
            sip_obj.bw_mamm,
            sip_obj.aw_mamm,
...
def gett2data(sip_obj):
    data = {
        ...
        "Acute": [
            '%.3e' %
            sip_obj.dose_mamm_out,
            '%.4f' %
            sip_obj.at_mamm_out,
            '%.4f' %
            sip_obj.acute_mamm_out,
            '%s' %
            sip_obj.acuconm_out,
        ],
        "Chronic": [
            ...
            sip_obj.act_out,
            '%.4f' %
            sip_obj.chron_mamm_out,
            '%s' %
            sip_obj.chronconm_out,
        ],
        "Units": [
            'mg/kg-bw',
            'mg/kg-bw',
...
def gett2dataqaqc(sip_obj):
    data = {
        ...
        "Acute-Expected": [
            '%.3e' %
            sip_obj.dose_mamm_out_expected,
            '%.4f' %
            sip_obj.at_mamm_out_expected,
            '%.4f' %
            sip_obj.acute_mamm_out_expected,
            '%s' %
            sip_obj.acuconm_out_expected,
        ],
        "Chronic": [
            '%.3e' %
            sip_obj.dose_mamm_out,
        ...
        "Chronic-Expected": [
            ...
            sip_obj.dose_mamm_out_expected,
            '%.4f' %
            sip_obj.act_out_expected,
            '%.4f' %
            sip_obj.chron_mamm_out_expected,
            '%s' %
            sip_obj.chronconm_out_expected,
        ],
        "Units": [
            'mg/kg-bw',
            'mg/kg-bw',
...
def gett3data(sip_obj):
    data = {
        ...
        "Acute": [
            '%.5e' %
            sip_obj.dose_bird_out,
            '%.4f' %
            sip_obj.at_bird_out,
            '%.4f' %
            sip_obj.acute_bird_out,
            '%s' %
            sip_obj.acuconb_out,
        ],
        "Chronic": [
            ...
            sip_obj.det_out,
            '%.4f' %
            sip_obj.chron_bird_out,
            '%s' %
            sip_obj.chronconb_out,
        ],
        "Units": [
            'mg/kg-bw',
            'mg/kg-bw',
...
def gett3dataqaqc(sip_obj):
    data = {
        ...
        "Acute-Expected": [
            '%.5e' %
            sip_obj.dose_bird_out_expected,
            '%.4f' %
            sip_obj.at_bird_out_expected,
            '%.4f' %
            sip_obj.acute_bird_out_expected,
            '%s' %
            sip_obj.acuconb_out_expected,
        ],
        "Chronic": [
            '%.5e' %
            sip_obj.dose_bird_out,
        ...
        "Chronic-Expected": [
            ...
            sip_obj.dose_bird_out_expected,
            '%.4f' %
            sip_obj.det_out_expected,
            '%.4f' %
            sip_obj.chron_bird_out_expected,
            '%s' %
            sip_obj.chronconb_out_expected,
        ],
        "Units": [
            'mg/kg-bw',
            'mg/kg-bw',

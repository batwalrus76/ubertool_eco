...
def gett1data(insect_obj):
    data = {
        "Parameter": [
            'Chemical Name',
            mark_safe('Solubility (in water @25&deg;C)'),
            mark_safe('Mammalian LD<sub>50</sub>'),
            'Body Weight of Tested Mammal',
            'Body Weight of Assessed Mammal',
            'Mammalian NOAEL',
            mark_safe('Avian LD<sub>50</sub>'),
            'Body Weight of Tested Bird',
            'Body Weight of Assessed Bird',
            'Mineau Scaling Factor',
            'Avian NOAEC',
        ],
        "Value": [
            insect_obj.chemical_name,
            insect_obj.sol,
            insect_obj.ld50_m,
            insect_obj.bw_mamm,
            insect_obj.aw_mamm,
...
def gett1dataqaqc(insect_obj):
    data = {
        ...
        "Value": [
            insect_obj.chemical_name_expected,
            insect_obj.sol,
            insect_obj.ld50_m,
            insect_obj.bw_mamm,
            insect_obj.aw_mamm,
...
def gett2data(insect_obj):
    data = {
        ...
        "Acute": [
            '%.3e' %
            insect_obj.dose_mamm_out,
            '%.4f' %
            insect_obj.at_mamm_out,
            '%.4f' %
            insect_obj.acute_mamm_out,
            '%s' %
            insect_obj.acuconm_out,
        ],
        "Chronic": [
            '%.3e' %
            insect_obj.dose_mamm_out,
            ...
            insect_obj.act_out,
            '%.4f' %
            insect_obj.chron_mamm_out,
            '%s' %
            insect_obj.chronconm_out,
        ],
        "Units": [
            'mg/kg-bw',
            'mg/kg-bw',
...
def gett2dataqaqc(insect_obj):
    data = {
        ...
        "Acute-Expected": [
            '%.3e' %
            insect_obj.dose_mamm_out_expected,
            '%.4f' %
            insect_obj.at_mamm_out_expected,
            '%.4f' %
            insect_obj.acute_mamm_out_expected,
            '%s' %
            insect_obj.acuconm_out_expected,
        ],
        "Chronic": [
            '%.3e' %
            insect_obj.dose_mamm_out,
        ...
        "Chronic-Expected": [
            ...
            insect_obj.dose_mamm_out_expected,
            '%.4f' %
            insect_obj.act_out_expected,
            '%.4f' %
            insect_obj.chron_mamm_out_expected,
            '%s' %
            insect_obj.chronconm_out_expected,
        ],
        "Units": [
            'mg/kg-bw',
            'mg/kg-bw',
...
def gett3data(insect_obj):
    data = {
        ...
        "Acute": [
            '%.5e' %
            insect_obj.dose_bird_out,
            '%.4f' %
            insect_obj.at_bird_out,
            '%.4f' %
            insect_obj.acute_bird_out,
            '%s' %
            insect_obj.acuconb_out,
        ],
        "Chronic": [
            '%.5e' %
            insect_obj.dose_bird_out,
            ...
            insect_obj.det_out,
            '%.4f' %
            insect_obj.chron_bird_out,
            '%s' %
            insect_obj.chronconb_out,
        ],
        "Units": [
            'mg/kg-bw',
            'mg/kg-bw',
...
def gett3dataqaqc(insect_obj):
    data = {
        ...
        "Acute-Expected": [
            '%.5e' %
            insect_obj.dose_bird_out_expected,
            '%.4f' %
            insect_obj.at_bird_out_expected,
            '%.4f' %
            insect_obj.acute_bird_out_expected,
            '%s' %
            insect_obj.acuconb_out_expected,
        ],
        "Chronic": [
            '%.5e' %
            insect_obj.dose_bird_out,
        ...
        "Chronic-Expected": [
            ...
            insect_obj.dose_bird_out_expected,
            '%.4f' %
            insect_obj.det_out_expected,
            '%.4f' %
            insect_obj.chron_bird_out_expected,
            '%s' %
            insect_obj.chronconb_out_expected,
        ],
        "Units": [
            'mg/kg-bw',
            'mg/kg-bw',
...
def gettsumdata(
    ...
    data = {
        ...
        "Mean": [
            ...
            numpy.mean(bw_duck),
            '%.2e' %
            numpy.mean(bwb_other),
            '%.2e' %
            numpy.mean(bw_rat),
            '%.2e' %
            numpy.mean(bwm_other),
            '%.2e' %
            numpy.mean(sol),
            '%.2e' %
...
def gettsumdata_out(
    ...
    data = {
        "Parameter": [
            'Upper Bound Exposure - Avian',
            'Upper Bound Exposure - Mammalian',
        ...
        "Mean": [
            '%.2e' %
            numpy.mean(dose_bird_out),
            '%.2e' %
            numpy.mean(dose_mamm_out),
            '%.2e' %
            numpy.mean(at_bird_out),
            '%.2e' %
            numpy.mean(at_mamm_out),
            '%.2e' %
            numpy.mean(act_out),
            '%.2e' %
            numpy.mean(det_out),
            '%.2e' %
            numpy.mean(acute_bird_out),
            '%.2e' %
            numpy.mean(acute_mamm_out),
            '%.2e' %
            numpy.mean(chron_bird_out),
            '%.2e' %
            numpy.mean(chron_mamm_out),
        ],
        "Std": [
            '%.2e' %
            numpy.std(dose_bird_out),
            '%.2e' %
            numpy.std(dose_mamm_out),
            '%.2e' %
            numpy.std(at_bird_out),
            '%.2e' %
            numpy.std(at_mamm_out),
            '%.2e' %
            numpy.std(act_out),
            '%.2e' %
            numpy.std(det_out),
            '%.2e' %
            numpy.std(acute_bird_out),
            '%.2e' %
            numpy.std(acute_mamm_out),
            '%.2e' %
            numpy.std(chron_bird_out),
            '%.2e' %
            numpy.std(chron_mamm_out),
        ],
        "Min": [
            '%.2e' %
            numpy.min(dose_bird_out),
            '%.2e' %
            numpy.min(dose_mamm_out),
            '%.2e' %
            numpy.min(at_bird_out),
            '%.2e' %
            numpy.min(at_mamm_out),
            '%.2e' %
            numpy.min(act_out),
            '%.2e' %
            numpy.min(det_out),
            '%.2e' %
            numpy.min(acute_bird_out),
            '%.2e' %
            numpy.min(acute_mamm_out),
            '%.2e' %
            numpy.min(chron_bird_out),
            '%.2e' %
            numpy.min(chron_mamm_out),
        ],
        "Max": [
            '%.2e' %
            numpy.max(dose_bird_out),
            '%.2e' %
            numpy.min(dose_mamm_out),
            '%.2e' %
            numpy.min(at_bird_out),
            '%.2e' %
            numpy.max(at_mamm_out),
            '%.2e' %
            numpy.max(act_out),
            '%.2e' %
            numpy.min(det_out),
            '%.2e' %
            numpy.max(acute_bird_out),
            '%.2e' %
            numpy.min(acute_mamm_out),
            '%.2e' %
            numpy.max(chron_bird_out),
            '%.2e' %
            numpy.max(chron_mamm_out),
        ],
        "Unit": [
            'mg/kg-bw',
            'mg/kg-bw',
...
def table_2_qaqc(insect_obj):
    ...
    html = html + \
        tmpl.render(Context(dict(data=t2rows, headings=pvrheadingsqaqc)))
    html = html + """
                </div>
        """
    return html
...
def table_3_qaqc(insect_obj):
    ...
    html = html + \
        tmpl.render(Context(dict(data=t3rows, headings=pvrheadingsqaqc)))
    html = html + """
                </div>
        </div>
        """

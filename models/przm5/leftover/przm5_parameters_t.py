...
dayEmerge_text = 16
monthEmerge_text = 2
dateEmerge_text = datetime.datetime.strptime(
    str(dayEmerge_text) +
    str(monthEmerge_text),
    "%d%m")
dayMature_text = 5
monthMature_text = 5
dateMature_text = datetime.datetime.strptime(
    str(dayMature_text) +
    str(monthMature_text),
    "%d%m")
dayHarvest_text = 12
monthHarvest_text = 5
dateHarvest_text = datetime.datetime.strptime(
    str(dayHarvest_text) +
    str(monthHarvest_text),
    "%d%m")

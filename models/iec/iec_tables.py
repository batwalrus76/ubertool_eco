...
def gettsumdata_1(LC50_pool, threshold_pool, dose_response_pool):
    data = {
        ...
        "Mean": [
            '%.2e' %
            numpy.mean(LC50_pool),
            '%.2e' %
            numpy.mean(threshold_pool),
            '%.2e' %
            numpy.mean(dose_response_pool)],
        "Std": [
            '%.2e' %
            numpy.std(LC50_pool),
            '%.2e' %
            numpy.std(threshold_pool),
            '%.2e' %
            numpy.std(dose_response_pool)],
        "Min": [
            '%.2e' %
            numpy.min(LC50_pool),
            '%.2e' %
            numpy.min(threshold_pool),
            '%.2e' %
            numpy.min(dose_response_pool)],
        "Max": [
            '%.2e' %
            numpy.max(LC50_pool),
            '%.2e' %
            numpy.max(threshold_pool),
            '%.2e' %
            numpy.max(dose_response_pool)],
    }
    return data
...
def gett2data(iec_obj):
    ...
    data = {
        ...
        "Value": [
            '%.2f' %
            iec_obj.z_score_f_out,
            '%.2e' %
            iec_obj.F8_f_out,
            '%.2f' %
            iec_obj.chance_f_out,
        ],
    }
    return data
...
def gettsumdata_2_un(z_score_f_pool, F8_f_pool, chance_f_pool):
    data = {
        ...
        "Mean": [
            '%.2e' %
            numpy.mean(z_score_f_pool),
            '%.2e' %
            numpy.mean(F8_f_pool),
            '%.2e' %
            numpy.mean(chance_f_pool)],
        "Std": [
            '%.2e' %
            numpy.std(z_score_f_pool),
            '%.2e' %
            numpy.std(F8_f_pool),
            '%.2e' %
            numpy.std(chance_f_pool)],
        "Min": [
            '%.2e' %
            numpy.min(z_score_f_pool),
            '%.2e' %
            numpy.min(F8_f_pool),
            '%.2e' %
            numpy.min(chance_f_pool)],
        "Max": [
            '%.2e' %
            numpy.max(z_score_f_pool),
            '%.2e' %
            numpy.max(F8_f_pool),
            '%.2e' %
            numpy.max(chance_f_pool)],
    }
    return data
...
def gett2dataqaqc(iec_obj):
    data = {
        ...
        "Expected Value": [
            '%.2f' %
            iec_obj.z_score_f_out_expected,
            '%.2e' %
            iec_obj.F8_f_out_expected,
            '%.2f' %
            iec_obj.chance_f_out_expected,
        ],
    }
    return data
...
def gettsumdata(dose_response, LC50, threshold):
    data = {
        ...
        "Mean": [
            '%.2e' %
            numpy.mean(dose_response),
            '%.2e' %
            numpy.mean(LC50),
            '%.2e' %
            numpy.mean(threshold),
        ],
        "Std": [
            '%.2e' %
            numpy.std(dose_response),
            '%.2e' %
            numpy.std(LC50),
            '%.2e' %
            numpy.std(threshold),
...
def gettsumdata_out(z_score_f_out, F8_f_out, chance_f_out):
    data = {
        ...
        "Mean": [
            '%.2e' %
            numpy.mean(z_score_f_out),
            '%.2e' %
            numpy.mean(F8_f_out),
            '%.2e' %
            numpy.mean(chance_f_out),
        ],
        "Std": [
            '%.2e' %
            numpy.std(z_score_f_out),
            '%.2e' %
            numpy.std(F8_f_out),
            '%.2e' %
            numpy.std(chance_f_out),
        ],
        "Min": [
            '%.2e' %
            numpy.min(z_score_f_out),
            '%.2e' %
            numpy.min(F8_f_out),
            '%.2e' %
            numpy.min(chance_f_out),
        ],
        "Max": [
            '%.2e' %
            numpy.max(z_score_f_out),
            '%.2e' %
            numpy.max(F8_f_out),
            '%.2e' %
            numpy.max(chance_f_out),
        ],
        "Unit": [
            '',
            'mg/kg-bw',
...
def table_all_un(
    ...
    html_all = html_all + \
        table_2_un(z_score_f_pool, threshold_pool, chance_f_pool)
    return html_all
...
def table_2_qaqc(iec_obj):
    ...
    html = html + \
        tmpl.render(Context(dict(data=t2rows, headings=ovheadingsqaqc)))
    html = html + """
            </div>
        """
    return html
...
def table_1_un(LC50_pool, threshold_pool, dose_response_pool):
    ...
    html = html + \
        tmpl.render(Context(dict(data=t1rows_un, headings=ivheadings_un)))
    html = html + """
            </div>
        """
    return html
...
def table_2_un(z_score_f_pool, F8_f_pool, chance_f_pool):
    ...
    html = html + \
        tmpl.render(Context(dict(data=t2rows_un, headings=ivheadings_un)))
    html = html + """
            </div>
        """
    return html

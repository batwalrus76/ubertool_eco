...
class TestCase_z_score_f_out(unittest.TestCase):
    ...
    def testz_score_f_out_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "Z_score_f", self.iec_obj.z_score_f_out, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.z_score_f_out, 3), testFailureMessage)
...
class TestCase_F8_f_out(unittest.TestCase):
    ...
    def testF8_f_out_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "F8_f", self.iec_obj.F8_f_out, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.F8_f_out, 3), testFailureMessage)
...
class TestCase_chance_f_out(unittest.TestCase):
    ...
    def testchance_f_out_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "Chance_f", self.iec_obj.chance_f_out, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.chance_f_out, 3), testFailureMessage)

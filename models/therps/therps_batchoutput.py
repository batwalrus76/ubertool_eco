...
def html_table(row_inp_all):
    ...
    ###Inputs###########
        ...
        therps_obj_temp = therps_model.therps(
            "batch",
            chem_name_temp,
            use_temp,
            formu_name_temp,
...
def loop_html(thefile):
    ...
    sum_2 = therps_tables.table_sum_2(
        ld50_bird,
        lc50_bird,
        NOAEC_bird,
        NOAEL_bird,
        ...
        bw_avian_NOAEL,
        x)
    sum_3 = therps_tables.table_sum_3(
        bw_herp_a_sm,
        bw_herp_a_md,
        bw_herp_a_lg,
        wp_herp_a_sm,
    ...
    <br>
        ...
        <div class="out_">
    """
    sum_5 = therps_tables.table_sum_5(
        "Upper Bound Kenaga",
        EEC_diet_herp_BL_out,
        EEC_ARQ_herp_BL_out,
        EEC_diet_herp_FR_out,
        ...
        EEC_diet_herp_TP_out,
        EEC_ARQ_herp_TP_out)
    sum_6 = therps_tables.table_sum_6(
        "Upper Bound Kenaga",
        EEC_diet_herp_BL_out,
        EEC_CRQ_herp_BL_out,
        EEC_diet_herp_FR_out,
        ...
        EEC_diet_herp_TP_out,
        EEC_CRQ_herp_TP_out)
    sum_7 = therps_tables.table_sum_7(
        "Upper Bound Kenaga",
        bw_herp_a_sm,
        bw_herp_a_md,
        bw_herp_a_lg,
    ...
    sum_8 = therps_tables.table_sum_5(
        "Mean Kenaga",
        EEC_diet_herp_BL_out_mean,
        EEC_ARQ_herp_BL_out_mean,
        EEC_diet_herp_FR_out_mean,
        ...
        EEC_diet_herp_TP_out_mean,
        EEC_ARQ_herp_TP_out_mean)
    sum_9 = therps_tables.table_sum_6(
        "Mean Kenaga",
        EEC_diet_herp_BL_out_mean,
        EEC_CRQ_herp_BL_out_mean,
        EEC_diet_herp_FR_out_mean,
        ...
        EEC_diet_herp_TP_out_mean,
        EEC_CRQ_herp_TP_out_mean)
    sum_10 = therps_tables.table_sum_7(
        "Mean Kenaga",
        bw_herp_a_sm,
        bw_herp_a_md,
        bw_herp_a_lg,
    ...
    """
    return sum_1 + sum_2 + sum_3 + sum_4 + sum_7 + sum_5 + sum_6 + sum_10 + \
        sum_8 + sum_9 + "".join(out_html_all_sort.values()) + html_end

...
def gett1data(therps_obj):
    data = {
        ...
        "Value": [
            '%s' %
            therps_obj.chem_name,
            '%s' %
            therps_obj.use,
            '%s' %
            therps_obj.formu_name,
            '%s' %
            therps_obj.a_i_disp,
            '%s' %
            therps_obj.h_l,
...
def gett2data(therps_obj):
    data = {
        ...
        "Value": [
            '%s' %
            therps_obj.avian_ld50,
            '%s' %
            therps_obj.Species_of_the_tested_bird_avian_ld50,
            '%s' %
            therps_obj.bw_avian_ld50,
            '%s' %
            therps_obj.avian_lc50,
            '%s' %
            therps_obj.Species_of_the_tested_bird_avian_lc50,
            '%s' %
            therps_obj.bw_avian_lc50,
            '%s' %
            therps_obj.avian_NOAEC,
            '%s' %
            therps_obj.Species_of_the_tested_bird_avian_NOAEC,
            '%s' %
            therps_obj.bw_avian_NOAEC,
            '%s' %
            therps_obj.avian_NOAEL,
            '%s' %
            therps_obj.Species_of_the_tested_bird_avian_NOAEL,
            '%s' %
            therps_obj.bw_avian_NOAEL,
            '%s' %
            therps_obj.mineau_scaling_factor,
        ],
        "Units": [
            'mg/kg-bw',
            '',
...
def gett3data(therps_obj):
    data = {
        "Parameter": [
            'Body weight of assessed small herptile',
            'Body weight of assessed medium herptile',
        ...
        "Value": [
            '%s' %
            therps_obj.bw_herp_a_sm,
            '%s' %
            therps_obj.bw_herp_a_md,
            '%s' %
            therps_obj.bw_herp_a_lg,
            '%s' %
            therps_obj.wp_herp_a_sm,
            '%s' %
            therps_obj.wp_herp_a_md,
            '%s' %
            therps_obj.wp_herp_a_lg,
            '%s' %
            therps_obj.c_mamm_a,
            '%s' %
            therps_obj.c_herp_a,
...
def gettsumdata_1(
    ...
    data = {
        ...
        "Mean": [
            '%.2e' %
            numpy.mean(percent_ai),
            '%.2e' %
            numpy.mean(Foliar_dissipation_half_life),
            '%.2e' %
            numpy.mean(number_of_applications),
            '%.2e' %
            numpy.mean(interval_between_applications),
            '%.2e' %
            numpy.mean(application_rate),
        ],
        "Std": [
            '%.2e' %
            numpy.std(percent_ai),
            '%.2e' %
            numpy.std(Foliar_dissipation_half_life),
            '%.2e' %
            numpy.std(number_of_applications),
            '%.2e' %
            numpy.std(interval_between_applications),
            '%.2e' %
            numpy.std(application_rate),
        ],
        "Min": [
            '%.2e' %
            numpy.min(percent_ai),
            '%.2e' %
            numpy.min(Foliar_dissipation_half_life),
            '%.2e' %
            numpy.min(number_of_applications),
            '%.2e' %
            numpy.min(interval_between_applications),
            '%.2e' %
            numpy.min(application_rate),
        ],
        "Max": [
            '%.2e' %
            numpy.max(percent_ai),
            '%.2e' %
            numpy.max(Foliar_dissipation_half_life),
            '%.2e' %
            numpy.max(number_of_applications),
            '%.2e' %
            numpy.max(interval_between_applications),
            '%.2e' %
            numpy.max(application_rate),
        ],
        "Unit": [
            '%',
            'days',
...
def gettsumdata_2(
    ...
    data = {
        "Parameter": [
            ...
            'Avian NOAEC',
            'Avian NOAEL',
            'Body weight of the tested bird (LD50)',
            'Body weight of the tested bird (LC50)',
            'Body weight of the tested bird (NOAEC)',
            'Body weight of the tested bird (NOAEL)',
            'Mineau scaling factor',
        ],
        "Mean": [
            '%.2e' %
            ...
            '%.2e' %
            numpy.mean(avian_lc50),
            '%.2e' %
            numpy.mean(avian_NOAEC),
            '%.2e' %
            numpy.mean(avian_NOAEL),
            '%.2e' %
            numpy.mean(bw_avian_ld50),
            '%.2e' %
            numpy.mean(bw_avian_lc50),
            '%.2e' %
            numpy.mean(bw_avian_NOAEC),
            '%.2e' %
            numpy.mean(bw_avian_NOAEL),
            '%.2e' %
        ...
        "Std": [
            ...
            '%.2e' %
            numpy.std(avian_lc50),
            '%.2e' %
            numpy.std(avian_NOAEC),
            '%.2e' %
            numpy.std(avian_NOAEL),
            '%.2e' %
            numpy.std(bw_avian_ld50),
            '%.2e' %
            numpy.std(bw_avian_lc50),
            '%.2e' %
            numpy.std(bw_avian_NOAEC),
            '%.2e' %
            numpy.std(bw_avian_NOAEL),
            '%.2e' %
            numpy.mean(mineau_scaling_factor),
        ],
        "Min": [
            ...
            '%.2e' %
            numpy.min(avian_lc50),
            '%.2e' %
            numpy.min(avian_NOAEC),
            '%.2e' %
            numpy.min(avian_NOAEL),
            '%.2e' %
            numpy.min(bw_avian_ld50),
            '%.2e' %
            numpy.min(bw_avian_lc50),
            '%.2e' %
            numpy.min(bw_avian_NOAEC),
            '%.2e' %
            numpy.min(bw_avian_NOAEL),
            '%.2e' %
            numpy.mean(mineau_scaling_factor),
        ],
        "Max": [
            ...
            '%.2e' %
            numpy.max(avian_lc50),
            '%.2e' %
            numpy.max(avian_NOAEC),
            '%.2e' %
            numpy.max(avian_NOAEL),
            '%.2e' %
            numpy.max(bw_avian_ld50),
            '%.2e' %
            numpy.max(bw_avian_lc50),
            '%.2e' %
            numpy.max(bw_avian_NOAEC),
            '%.2e' %
            numpy.max(bw_avian_NOAEL),
            '%.2e' %
            numpy.mean(mineau_scaling_factor),
        ],
        "Unit": [
...
def gettsumdata_3(
    ...
    data = {
        ...
        "Mean": [
            '%.2e' %
            numpy.mean(bw_herp_a_sm),
            '%.2e' %
            numpy.mean(bw_herp_a_md),
            '%.2e' %
            numpy.mean(bw_herp_a_lg),
            '%.2e' %
            numpy.mean(wp_herp_a_sm),
            '%.2e' %
            numpy.mean(wp_herp_a_md),
            '%.2e' %
            numpy.mean(wp_herp_a_lg),
            '%.2e' %
            numpy.mean(c_mamm_a),
            '%.2e' %
            numpy.mean(c_herp_a)],
        "Std": [
            '%.2e' %
            numpy.std(bw_herp_a_sm),
            '%.2e' %
            numpy.std(bw_herp_a_md),
            '%.2e' %
            numpy.std(bw_herp_a_lg),
            '%.2e' %
            numpy.std(wp_herp_a_sm),
            '%.2e' %
            numpy.std(wp_herp_a_md),
            '%.2e' %
            numpy.mean(wp_herp_a_lg),
            '%.2e' %
            numpy.mean(c_mamm_a),
        ...
        "Min": [
            '%.2e' %
            numpy.min(bw_herp_a_sm),
            '%.2e' %
            numpy.min(bw_herp_a_md),
            '%.2e' %
            numpy.min(bw_herp_a_lg),
            '%.2e' %
            numpy.min(wp_herp_a_sm),
            '%.2e' %
            numpy.min(wp_herp_a_md),
            '%.2e' %
            numpy.mean(wp_herp_a_lg),
            '%.2e' %
            numpy.mean(c_mamm_a),
        ...
        "Max": [
            '%.2e' %
            numpy.max(bw_herp_a_sm),
            '%.2e' %
            numpy.max(bw_herp_a_md),
            '%.2e' %
            numpy.max(bw_herp_a_lg),
            '%.2e' %
            numpy.max(wp_herp_a_sm),
            '%.2e' %
            numpy.max(wp_herp_a_md),
            '%.2e' %
            numpy.mean(wp_herp_a_lg),
            '%.2e' %
            numpy.mean(c_mamm_a),
...
def gettsumdata_5(
    ...
    data = {
        ...
        "EEC_BP": [
            '%.2e' %
            numpy.mean(EEC_diet_herp_BL_out),
            '%.2e' %
            numpy.std(EEC_diet_herp_BL_out),
            '%.2e' %
            numpy.min(EEC_diet_herp_BL_out),
            '%.2e' %
            numpy.max(EEC_diet_herp_BL_out)],
        "ARQ_BP": [
            '%.2e' %
            numpy.mean(EEC_ARQ_herp_BL_out),
            '%.2e' %
            numpy.std(EEC_ARQ_herp_BL_out),
            '%.2e' %
            numpy.min(EEC_ARQ_herp_BL_out),
            '%.2e' %
            numpy.max(EEC_ARQ_herp_BL_out)],
        "EEC_FR": [
            '%.2e' %
            numpy.mean(EEC_diet_herp_FR_out),
            '%.2e' %
            numpy.std(EEC_diet_herp_FR_out),
            '%.2e' %
            numpy.min(EEC_diet_herp_FR_out),
            '%.2e' %
            numpy.max(EEC_diet_herp_FR_out)],
        "ARQ_FR": [
            '%.2e' %
            numpy.mean(EEC_ARQ_herp_FR_out),
            '%.2e' %
            numpy.std(EEC_ARQ_herp_FR_out),
            '%.2e' %
            numpy.min(EEC_ARQ_herp_FR_out),
            '%.2e' %
            numpy.max(EEC_ARQ_herp_FR_out)],
        "EEC_HM": [
            '%.2e' %
            numpy.mean(EEC_diet_herp_HM_out),
            '%.2e' %
            numpy.std(EEC_diet_herp_HM_out),
            '%.2e' %
            numpy.min(EEC_diet_herp_HM_out),
            '%.2e' %
            numpy.max(EEC_diet_herp_HM_out)],
        "ARQ_HM": [
            '%.2e' %
            numpy.mean(EEC_ARQ_herp_HM_out),
            '%.2e' %
            numpy.std(EEC_ARQ_herp_HM_out),
            '%.2e' %
            numpy.min(EEC_ARQ_herp_HM_out),
            '%.2e' %
            numpy.max(EEC_ARQ_herp_HM_out)],
        "EEC_IM": [
            '%.2e' %
            numpy.mean(EEC_diet_herp_IM_out),
            '%.2e' %
            numpy.std(EEC_diet_herp_IM_out),
            '%.2e' %
            numpy.min(EEC_diet_herp_IM_out),
            '%.2e' %
            numpy.max(EEC_diet_herp_IM_out)],
        "ARQ_IM": [
            '%.2e' %
            numpy.mean(EEC_ARQ_herp_IM_out),
            '%.2e' %
            numpy.std(EEC_ARQ_herp_IM_out),
            '%.2e' %
            numpy.min(EEC_ARQ_herp_IM_out),
            '%.2e' %
            numpy.max(EEC_ARQ_herp_IM_out)],
        "EEC_TP": [
            '%.2e' %
            numpy.mean(EEC_diet_herp_TP_out),
            '%.2e' %
            numpy.std(EEC_diet_herp_TP_out),
            '%.2e' %
            numpy.min(EEC_diet_herp_TP_out),
            '%.2e' %
            numpy.max(EEC_diet_herp_TP_out)],
        "ARQ_TP": [
            '%.2e' %
            numpy.mean(EEC_ARQ_herp_TP_out),
            '%.2e' %
            numpy.std(EEC_ARQ_herp_TP_out),
            '%.2e' %
            numpy.min(EEC_ARQ_herp_TP_out),
            '%.2e' %
            numpy.max(EEC_ARQ_herp_TP_out)],
    }
    return data
...
def gettsumdata_6(
    ...
    data = {
        ...
        "ARQ_BP": [
            '%.2e' %
            numpy.mean(EEC_CRQ_herp_BL_out),
            '%.2e' %
            numpy.std(EEC_CRQ_herp_BL_out),
            '%.2e' %
            numpy.min(EEC_CRQ_herp_BL_out),
            '%.2e' %
            numpy.max(EEC_CRQ_herp_BL_out)],
        "EEC_FR": [
            '%.2e' %
            numpy.mean(EEC_diet_herp_FR_out),
            '%.2e' %
        ...
        "ARQ_FR": [
            '%.2e' %
            numpy.mean(EEC_CRQ_herp_FR_out),
            '%.2e' %
            numpy.std(EEC_CRQ_herp_FR_out),
            '%.2e' %
            numpy.min(EEC_CRQ_herp_FR_out),
            '%.2e' %
            numpy.max(EEC_CRQ_herp_FR_out)],
        "EEC_HM": [
            '%.2e' %
            numpy.mean(EEC_diet_herp_HM_out),
            '%.2e' %
        ...
        "ARQ_HM": [
            '%.2e' %
            numpy.mean(EEC_CRQ_herp_HM_out),
            '%.2e' %
            numpy.std(EEC_CRQ_herp_HM_out),
            '%.2e' %
            numpy.min(EEC_CRQ_herp_HM_out),
            '%.2e' %
            numpy.max(EEC_CRQ_herp_HM_out)],
        "EEC_IM": [
            '%.2e' %
            numpy.mean(EEC_diet_herp_IM_out),
            '%.2e' %
        ...
        "ARQ_IM": [
            '%.2e' %
            numpy.mean(EEC_CRQ_herp_IM_out),
            '%.2e' %
            numpy.std(EEC_CRQ_herp_IM_out),
            '%.2e' %
            numpy.min(EEC_CRQ_herp_IM_out),
            '%.2e' %
            numpy.max(EEC_CRQ_herp_IM_out)],
        "EEC_TP": [
            '%.2e' %
            numpy.mean(EEC_diet_herp_TP_out),
            '%.2e' %
        ...
        "ARQ_TP": [
            '%.2e' %
            numpy.mean(EEC_CRQ_herp_TP_out),
            '%.2e' %
            numpy.std(EEC_CRQ_herp_TP_out),
            '%.2e' %
            numpy.min(EEC_CRQ_herp_TP_out),
            '%.2e' %
            numpy.max(EEC_CRQ_herp_TP_out)],
    }
    return data
...
def gettsumdata_7(
    ...
    data = {
        ...
        "Size": [
            '%.2e' %
            numpy.mean(bw_herp_a_sm_out),
            '%.2e' %
            numpy.std(bw_herp_a_sm_out),
            '%.2e' %
            numpy.min(bw_herp_a_sm_out),
            '%.2e' %
            numpy.max(bw_herp_a_sm_out),
            '%.2e' %
            numpy.mean(bw_herp_a_md_out),
            '%.2e' %
            numpy.std(bw_herp_a_md_out),
            '%.2e' %
            numpy.min(bw_herp_a_md_out),
            '%.2e' %
            numpy.max(bw_herp_a_md_out),
            '%.2e' %
            numpy.mean(bw_herp_a_lg_out),
            '%.2e' %
            numpy.std(bw_herp_a_lg_out),
            '%.2e' %
            numpy.min(bw_herp_a_lg_out),
            '%.2e' %
            numpy.max(bw_herp_a_lg_out),
        ],
        "LD50_AD": [
            '%.2e' %
            numpy.mean(LD50_AD_sm_out),
            '%.2e' %
            numpy.std(LD50_AD_sm_out),
            '%.2e' %
            numpy.min(LD50_AD_sm_out),
            '%.2e' %
            numpy.max(LD50_AD_sm_out),
            '%.2e' %
            numpy.mean(LD50_AD_md_out),
            '%.2e' %
            numpy.std(LD50_AD_md_out),
            '%.2e' %
            numpy.min(LD50_AD_md_out),
            '%.2e' %
            numpy.max(LD50_AD_md_out),
            '%.2e' %
            numpy.mean(LD50_AD_lg_out),
            '%.2e' %
            numpy.std(LD50_AD_lg_out),
            '%.2e' %
            numpy.min(LD50_AD_lg_out),
            '%.2e' %
            numpy.max(LD50_AD_lg_out),
        ],
        "EEC_BP": [
            '%.2e' %
            numpy.mean(EEC_dose_BP_sm_out),
            '%.2e' %
            numpy.std(EEC_dose_BP_sm_out),
            '%.2e' %
            numpy.min(EEC_dose_BP_sm_out),
            '%.2e' %
            numpy.max(EEC_dose_BP_sm_out),
            '%.2e' %
            numpy.mean(EEC_dose_BP_md_out),
            '%.2e' %
            numpy.std(EEC_dose_BP_md_out),
            '%.2e' %
            numpy.min(EEC_dose_BP_md_out),
            '%.2e' %
            numpy.max(EEC_dose_BP_md_out),
            '%.2e' %
            numpy.mean(EEC_dose_BP_lg_out),
            '%.2e' %
            numpy.std(EEC_dose_BP_lg_out),
            '%.2e' %
            numpy.min(EEC_dose_BP_lg_out),
            '%.2e' %
            numpy.max(EEC_dose_BP_lg_out),
        ],
        "ARQ_BP": [
            '%.2e' %
            numpy.mean(ARQ_dose_BP_sm_out),
            '%.2e' %
            numpy.std(ARQ_dose_BP_sm_out),
            '%.2e' %
            numpy.min(ARQ_dose_BP_sm_out),
            '%.2e' %
            numpy.max(ARQ_dose_BP_sm_out),
            '%.2e' %
            numpy.mean(ARQ_dose_BP_md_out),
            '%.2e' %
            numpy.std(ARQ_dose_BP_md_out),
            '%.2e' %
            numpy.min(ARQ_dose_BP_md_out),
            '%.2e' %
            numpy.max(ARQ_dose_BP_md_out),
            '%.2e' %
            numpy.mean(ARQ_dose_BP_lg_out),
            '%.2e' %
            numpy.std(ARQ_dose_BP_lg_out),
            '%.2e' %
            numpy.min(ARQ_dose_BP_lg_out),
            '%.2e' %
            numpy.max(ARQ_dose_BP_lg_out),
        ],
        "EEC_FR": [
            '%.2e' %
            numpy.mean(EEC_dose_FR_sm_out),
            '%.2e' %
            numpy.std(EEC_dose_FR_sm_out),
            '%.2e' %
            numpy.min(EEC_dose_FR_sm_out),
            '%.2e' %
            numpy.max(EEC_dose_FR_sm_out),
            '%.2e' %
            numpy.mean(EEC_dose_FR_md_out),
            '%.2e' %
            numpy.std(EEC_dose_FR_md_out),
            '%.2e' %
            numpy.min(EEC_dose_FR_md_out),
            '%.2e' %
            numpy.max(EEC_dose_FR_md_out),
            '%.2e' %
            numpy.mean(EEC_dose_FR_lg_out),
            '%.2e' %
            numpy.std(EEC_dose_FR_lg_out),
            '%.2e' %
            numpy.min(EEC_dose_FR_lg_out),
            '%.2e' %
            numpy.max(EEC_dose_FR_lg_out),
        ],
        "ARQ_FR": [
            '%.2e' %
            numpy.mean(ARQ_dose_FR_sm_out),
            '%.2e' %
            numpy.std(ARQ_dose_FR_sm_out),
            '%.2e' %
            numpy.min(ARQ_dose_FR_sm_out),
            '%.2e' %
            numpy.max(ARQ_dose_FR_sm_out),
            '%.2e' %
            numpy.mean(ARQ_dose_FR_md_out),
            '%.2e' %
            numpy.std(ARQ_dose_FR_md_out),
            '%.2e' %
            numpy.min(ARQ_dose_FR_md_out),
            '%.2e' %
            numpy.max(ARQ_dose_FR_md_out),
            '%.2e' %
            numpy.mean(ARQ_dose_FR_lg_out),
            '%.2e' %
            numpy.std(ARQ_dose_FR_lg_out),
            '%.2e' %
            numpy.min(ARQ_dose_FR_lg_out),
            '%.2e' %
            numpy.max(ARQ_dose_FR_lg_out),
        ],
        "EEC_HM": [
            'N/A',
            'N/A',
            ...
            'N/A',
            '%.2e' %
            numpy.mean(EEC_dose_HM_md_out),
            '%.2e' %
            numpy.std(EEC_dose_HM_md_out),
            '%.2e' %
            numpy.min(EEC_dose_HM_md_out),
            '%.2e' %
            numpy.max(EEC_dose_HM_md_out),
            '%.2e' %
            numpy.mean(EEC_dose_HM_lg_out),
            '%.2e' %
            numpy.std(EEC_dose_HM_lg_out),
            '%.2e' %
            numpy.min(EEC_dose_HM_lg_out),
            '%.2e' %
            numpy.max(EEC_dose_HM_lg_out),
        ],
        "ARQ_HM": [
            'N/A',
            'N/A',
            ...
            'N/A',
            '%.2e' %
            numpy.mean(ARQ_dose_HM_md_out),
            '%.2e' %
            numpy.std(ARQ_dose_HM_md_out),
            '%.2e' %
            numpy.min(ARQ_dose_HM_md_out),
            '%.2e' %
            numpy.max(ARQ_dose_HM_md_out),
            '%.2e' %
            numpy.mean(ARQ_dose_HM_lg_out),
            '%.2e' %
            numpy.std(ARQ_dose_HM_lg_out),
            '%.2e' %
            numpy.min(ARQ_dose_HM_lg_out),
            '%.2e' %
            numpy.max(ARQ_dose_HM_lg_out),
        ],
        "EEC_IM": [
            'N/A',
            'N/A',
            ...
            'N/A',
            '%.2e' %
            numpy.mean(EEC_dose_IM_md_out),
            '%.2e' %
            numpy.std(EEC_dose_IM_md_out),
            '%.2e' %
            numpy.min(EEC_dose_IM_md_out),
            '%.2e' %
            numpy.max(EEC_dose_IM_md_out),
            '%.2e' %
            numpy.mean(EEC_dose_IM_lg_out),
            '%.2e' %
            numpy.std(EEC_dose_IM_lg_out),
            '%.2e' %
            numpy.min(EEC_dose_IM_lg_out),
            '%.2e' %
            numpy.max(EEC_dose_IM_lg_out),
        ],
        "ARQ_IM": [
            'N/A',
            'N/A',
            ...
            'N/A',
            '%.2e' %
            numpy.mean(ARQ_dose_IM_md_out),
            '%.2e' %
            numpy.std(ARQ_dose_IM_md_out),
            '%.2e' %
            numpy.min(ARQ_dose_IM_md_out),
            '%.2e' %
            numpy.max(ARQ_dose_IM_md_out),
            '%.2e' %
            numpy.mean(ARQ_dose_IM_lg_out),
            '%.2e' %
            numpy.std(ARQ_dose_IM_lg_out),
            '%.2e' %
            numpy.min(ARQ_dose_IM_lg_out),
            '%.2e' %
            numpy.max(ARQ_dose_IM_lg_out),
        ],
        "EEC_TP": [
            'N/A',
            'N/A',
            ...
            'N/A',
            '%.2e' %
            numpy.mean(EEC_dose_TP_md_out),
            '%.2e' %
            numpy.std(EEC_dose_TP_md_out),
            '%.2e' %
            numpy.min(EEC_dose_TP_md_out),
            '%.2e' %
            numpy.max(EEC_dose_TP_md_out),
            '%.2e' %
            numpy.mean(EEC_dose_TP_lg_out),
            '%.2e' %
            numpy.std(EEC_dose_TP_lg_out),
            '%.2e' %
            numpy.min(EEC_dose_TP_lg_out),
            '%.2e' %
            numpy.max(EEC_dose_TP_lg_out),
        ],
        "ARQ_TP": [
            'N/A',
            'N/A',
            ...
            'N/A',
            '%.2e' %
            numpy.mean(ARQ_dose_TP_md_out),
            '%.2e' %
            numpy.std(ARQ_dose_TP_md_out),
            '%.2e' %
            numpy.min(ARQ_dose_TP_md_out),
            '%.2e' %
            numpy.max(ARQ_dose_TP_md_out),
            '%.2e' %
            numpy.mean(ARQ_dose_TP_lg_out),
            '%.2e' %
            numpy.std(ARQ_dose_TP_lg_out),
            '%.2e' %
            numpy.min(ARQ_dose_TP_lg_out),
            '%.2e' %
            numpy.max(ARQ_dose_TP_lg_out),
        ],
    }
    return data
...
def table_all_qaqc(therps_obj):
    ...
    html_all = table1_out + table2_out + table3_out + table5_out_qaqc + table6_out_qaqc + \
        table7_out_qaqc + table8_out_qaqc + table9_out_qaqc + table10_out_qaqc
...
def table_sum_5(
    ...
    html = html + \
        tmpl_5.render(Context(dict(data=tsuminputrows_5, l_headings=sumheadings_5[0][0])))
    html = html + """
        </div>
        """
    return html
...
def table_sum_6(
    ...
    html = html + \
        tmpl_5.render(Context(dict(data=tsuminputrows_6, l_headings=sumheadings_5[0][0])))
    html = html + """
        </div>
        """
    return html
...
def table_5(therps_obj):
    ...
    return {
        'html': html,
        'LD50_AD_sm': LD50_AD_sm,
        'LD50_AD_md': LD50_AD_md,
        'LD50_AD_lg': LD50_AD_lg,
        'EEC_dose_BP_sm': EEC_dose_BP_sm,
        'EEC_dose_BP_md': EEC_dose_BP_md,
        'EEC_dose_BP_lg': EEC_dose_BP_lg,
        'ARQ_dose_BP_sm': ARQ_dose_BP_sm,
        'ARQ_dose_BP_md': ARQ_dose_BP_md,
        'ARQ_dose_BP_lg': ARQ_dose_BP_lg,
        'EEC_dose_FR_sm': EEC_dose_FR_sm,
        'EEC_dose_FR_md': EEC_dose_FR_md,
        'EEC_dose_FR_lg': EEC_dose_FR_lg,
        'ARQ_dose_FR_sm': ARQ_dose_FR_sm,
        'ARQ_dose_FR_md': ARQ_dose_FR_md,
        'ARQ_dose_FR_lg': ARQ_dose_FR_lg,
        'EEC_dose_HM_md': EEC_dose_HM_md,
        'EEC_dose_HM_lg': EEC_dose_HM_lg,
        'ARQ_dose_HM_md': ARQ_dose_HM_md,
        'ARQ_dose_HM_lg': ARQ_dose_HM_lg,
        'EEC_dose_IM_md': EEC_dose_IM_md,
        'EEC_dose_IM_lg': EEC_dose_IM_lg,
        'ARQ_dose_IM_md': ARQ_dose_IM_md,
        'ARQ_dose_IM_lg': ARQ_dose_IM_lg,
        'EEC_dose_TP_md': EEC_dose_TP_md,
        'EEC_dose_TP_lg': EEC_dose_TP_lg,
        'ARQ_dose_TP_md': ARQ_dose_TP_md,
        'ARQ_dose_TP_lg': ARQ_dose_TP_lg}
...
def table_6(therps_obj):
    ...
    html = html + \
        tmpl_5.render(Context(dict(data=t6rows, l_headings=pv6headings[0][0])))
    html = html + """
                </div>
        """
    return {
        'html': html,
        'EEC_diet_herp_BL': EEC_diet_herp_BL,
        'EEC_ARQ_herp_BL': EEC_ARQ_herp_BL,
        'EEC_diet_herp_FR': EEC_diet_herp_FR,
        'EEC_ARQ_herp_FR': EEC_ARQ_herp_FR,
        'EEC_diet_herp_HM': EEC_diet_herp_HM,
        'EEC_ARQ_herp_HM': EEC_ARQ_herp_HM,
        'EEC_diet_herp_IM': EEC_diet_herp_IM,
        'EEC_ARQ_herp_IM': EEC_ARQ_herp_IM,
        'EEC_diet_herp_TP': EEC_diet_herp_TP,
        'EEC_ARQ_herp_TP': EEC_ARQ_herp_TP}
...
def table_7(therps_obj):
    ...
    html = html + \
        tmpl_5.render(Context(dict(data=t7rows, l_headings=pv7headings[0][0])))
    html = html + """
                </div>
        """
    return {
        'html': html,
        'EEC_diet_herp_BL': EEC_diet_herp_BL,
        'EEC_CRQ_herp_BL': EEC_CRQ_herp_BL,
        'EEC_diet_herp_FR': EEC_diet_herp_FR,
        'EEC_CRQ_herp_FR': EEC_CRQ_herp_FR,
        'EEC_diet_herp_HM': EEC_diet_herp_HM,
        'EEC_CRQ_herp_HM': EEC_CRQ_herp_HM,
        'EEC_diet_herp_IM': EEC_diet_herp_IM,
        'EEC_CRQ_herp_IM': EEC_CRQ_herp_IM,
        'EEC_diet_herp_TP': EEC_diet_herp_TP,
        'EEC_CRQ_herp_TP': EEC_CRQ_herp_TP}
...
def table_8(therps_obj):
    ...
    return {
        ...
        'LD50_AD_md': LD50_AD_md,
        'LD50_AD_lg': LD50_AD_lg,
        'EEC_dose_BP_sm': EEC_dose_BP_sm_mean,
        'EEC_dose_BP_md': EEC_dose_BP_md_mean,
        'EEC_dose_BP_lg': EEC_dose_BP_lg_mean,
        'ARQ_dose_BP_sm': ARQ_dose_BP_sm_mean,
        'ARQ_dose_BP_md': ARQ_dose_BP_md_mean,
        'ARQ_dose_BP_lg': ARQ_dose_BP_lg_mean,
        'EEC_dose_FR_sm': EEC_dose_FR_sm_mean,
        'EEC_dose_FR_md': EEC_dose_FR_md_mean,
        'EEC_dose_FR_lg': EEC_dose_FR_lg_mean,
        'ARQ_dose_FR_sm': ARQ_dose_FR_sm_mean,
        'ARQ_dose_FR_md': ARQ_dose_FR_md_mean,
        'ARQ_dose_FR_lg': ARQ_dose_FR_lg_mean,
        'EEC_dose_HM_md': EEC_dose_HM_md_mean,
        'EEC_dose_HM_lg': EEC_dose_HM_lg_mean,
        'ARQ_dose_HM_md': ARQ_dose_HM_md_mean,
        'ARQ_dose_HM_lg': ARQ_dose_HM_lg_mean,
        'EEC_dose_IM_md': EEC_dose_IM_md_mean,
        'EEC_dose_IM_lg': EEC_dose_IM_lg_mean,
        'ARQ_dose_IM_md': ARQ_dose_IM_md_mean,
        'ARQ_dose_IM_lg': ARQ_dose_IM_lg_mean,
        'EEC_dose_TP_md': EEC_dose_TP_md_mean,
        'EEC_dose_TP_lg': EEC_dose_TP_lg_mean,
        'ARQ_dose_TP_md': ARQ_dose_TP_md_mean,
...
def table_9(therps_obj):
    ...
    t9data = gett6data(
        therps_obj.avian_lc50,
        EEC_diet_herp_BL_mean,
        EEC_ARQ_herp_BL_mean,
        EEC_diet_herp_FR_mean,
        EEC_ARQ_herp_FR_mean,
        EEC_diet_herp_HM_mean,
        EEC_ARQ_herp_HM_mean,
        EEC_diet_herp_IM_mean,
        EEC_ARQ_herp_IM_mean,
        EEC_diet_herp_TP_mean,
        EEC_ARQ_herp_TP_mean)
    t9rows = gethtmlrowsfromcols(t9data, pv6headings[1])
    html = html + \
        tmpl_5.render(Context(dict(data=t9rows, l_headings=pv6headings[0][0])))
    html = html + """
                </div>
        """
    return {
        'html': html,
        'EEC_diet_herp_BL': EEC_diet_herp_BL_mean,
        'EEC_ARQ_herp_BL': EEC_ARQ_herp_BL_mean,
        'EEC_diet_herp_FR': EEC_diet_herp_FR_mean,
        'EEC_ARQ_herp_FR': EEC_ARQ_herp_FR_mean,
        'EEC_diet_herp_HM': EEC_diet_herp_HM_mean,
        'EEC_ARQ_herp_HM': EEC_ARQ_herp_HM_mean,
        'EEC_diet_herp_IM': EEC_diet_herp_IM_mean,
        'EEC_ARQ_herp_IM': EEC_ARQ_herp_IM_mean,
        'EEC_diet_herp_TP': EEC_diet_herp_TP_mean,
        'EEC_ARQ_herp_TP': EEC_ARQ_herp_TP_mean}
...
def table_10(therps_obj):
    ...
    t10data = gett7data(
        therps_obj.avian_NOAEC,
        EEC_diet_herp_BL_mean,
        EEC_CRQ_herp_BL_mean,
        EEC_diet_herp_FR_mean,
        EEC_CRQ_herp_FR_mean,
        EEC_diet_herp_HM_mean,
        EEC_CRQ_herp_HM_mean,
        EEC_diet_herp_IM_mean,
        EEC_CRQ_herp_IM_mean,
        EEC_diet_herp_TP_mean,
        EEC_CRQ_herp_TP_mean)
    t10rows = gethtmlrowsfromcols(t10data, pv7headings[1])
    html = html + \
        tmpl_5.render(Context(dict(data=t10rows, l_headings=pv7headings[0][0])))
    html = html + """
                </div>
        """
    return {
        'html': html,
        'EEC_diet_herp_BL': EEC_diet_herp_BL_mean,
        'EEC_CRQ_herp_BL': EEC_CRQ_herp_BL_mean,
        'EEC_diet_herp_FR': EEC_diet_herp_FR_mean,
        'EEC_CRQ_herp_FR': EEC_CRQ_herp_FR_mean,
        'EEC_diet_herp_HM': EEC_diet_herp_HM_mean,
        'EEC_CRQ_herp_HM': EEC_CRQ_herp_HM_mean,
        'EEC_diet_herp_IM': EEC_diet_herp_IM_mean,
        'EEC_CRQ_herp_IM': EEC_CRQ_herp_IM_mean,
        'EEC_diet_herp_TP': EEC_diet_herp_TP_mean,
        'EEC_CRQ_herp_TP': EEC_CRQ_herp_TP_mean}
    ...
    html = html + tmpl_5.render(
        Context(
            dict(
                data=t5rows_qaqc,
                l_headings=[
                    pv5headings_qaqc[0][0][0],
                    pv5headings_qaqc[0][0][1],
    ...
    html = html + tmpl_5.render(
        Context(
            dict(
                data=t6rows_qaqc,
                l_headings=[
                    pv6headings_qaqc[0][0][0],
                    pv6headings_qaqc[0][0][1]])))
    html = html + """
                </div>
        """
    return html
    ...
    html = html + tmpl_5.render(
        Context(
            dict(
                data=t7rows_qaqc,
                l_headings=[
                    pv7headings_qaqc[0][0][0],
                    pv7headings_qaqc[0][0][1]])))
    html = html + """
                </div>
        """
    return html

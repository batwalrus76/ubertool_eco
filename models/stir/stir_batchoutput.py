...
def html_table(row_inp_all):
    while True:
        ...
        if row_inp_temp_all is None:
            ...
            duration_mammal_inhalation_study.append(
                duration_mammal_inhalation_study_temp)
            body_weight_assessed_mammal_temp = float(row[13])
            body_weight_assessed_mammal.append(
                body_weight_assessed_mammal_temp)
            ...
            stir_obj_temp = stir_model.StirModel(
                True,
                True,
                chemical_name_temp,
                application_rate_temp,
                column_height_temp,
                spray_drift_fraction_temp,
                direct_spray_duration_temp,
                molecular_weight_temp,
                vapor_pressure_temp,
                avian_oral_ld50_temp,
                body_weight_assessed_bird_temp,
                body_weight_tested_bird_temp,
                mineau_scaling_factor_temp,
                mammal_inhalation_lc50_temp,
                duration_mammal_inhalation_study_temp,
                body_weight_assessed_mammal_temp,
                body_weight_tested_mammal_temp,
            ...
            mammal_inhalation_ld50_out.append(
                stir_obj_temp.mammal_inhalation_ld50)
            adjusted_mammal_inhalation_ld50_out.append(
                stir_obj_temp.adjusted_mammal_inhalation_ld50)
            estimated_avian_inhalation_ld50_out.append(
                stir_obj_temp.estimated_avian_inhalation_ld50)
            adjusted_avian_inhalation_ld50_out.append(
                stir_obj_temp.adjusted_avian_inhalation_ld50)

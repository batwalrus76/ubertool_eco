...
class TestCase_sat_air_conc(unittest.TestCase):
    ...
    def testsat_air_conc_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "sat_air_conc", self.stir_obj.sat_air_conc, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.sat_air_conc, 3), testFailureMessage)
...
class TestCase_inh_rate_avian(unittest.TestCase):
    ...
    def testinh_rate_avian_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "inh_rate_avian", self.stir_obj.inh_rate_avian, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.inh_rate_avian, 3), testFailureMessage)
...
class TestCase_vid_avian(unittest.TestCase):
    ...
    def testvid_avian_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "vid_avian", self.stir_obj.vid_avian, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.vid_avian, 3), testFailureMessage)
...
class TestCase_inh_rate_mammal(unittest.TestCase):
    ...
    def testinh_rate_mammal_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "inh_rate_mammal", self.stir_obj.inh_rate_mammal, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.inh_rate_mammal, 3), testFailureMessage)
...
class TestCase_vid_mammal(unittest.TestCase):
    ...
    def testvid_mammal_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "vid_mammal", self.stir_obj.vid_mammal, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.vid_mammal, 3), testFailureMessage)
...
class TestCase_air_conc(unittest.TestCase):
    ...
    def testair_conc_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "air_conc", self.stir_obj.air_conc, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.air_conc, 3), testFailureMessage)
...
class TestCase_sid_avian(unittest.TestCase):
    ...
    def testsid_avian_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "sid_avian", self.stir_obj.sid_avian, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.sid_avian, 3), testFailureMessage)
...
class TestCase_sid_mammal(unittest.TestCase):
    ...
    def testsid_mammal_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "sid_mammal", self.stir_obj.sid_mammal, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.sid_mammal, 3), testFailureMessage)
...
class TestCase_mammal_inhalation_ld50(unittest.TestCase):
    ...
    def testmammal_inhalation_ld50_in(self):
        out_fun_mammal_inhalation_ld50.append(
            self.stir_obj.mammal_inhalation_ld50)
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "mammal_inhalation_ld50", self.stir_obj.mammal_inhalation_ld50, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.mammal_inhalation_ld50, 3), testFailureMessage)
...
class TestCase_adjusted_mammal_inhalation_ld50(unittest.TestCase):
    ...
    def testadjusted_mammal_inhalation_ld50_in(self):
        out_fun_adjusted_mammal_inhalation_ld50.append(
            self.stir_obj.adjusted_mammal_inhalation_ld50)
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "adjusted_mammal_inhalation_ld50", self.stir_obj.adjusted_mammal_inhalation_ld50, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.adjusted_mammal_inhalation_ld50, 3), testFailureMessage)
...
class TestCase_estimated_avian_inhalation_ld50(unittest.TestCase):
    ...
    def testestimated_avian_inhalation_ld50_in(self):
        out_fun_estimated_avian_inhalation_ld50.append(
            self.stir_obj.estimated_avian_inhalation_ld50)
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "estimated_avian_inhalation_ld50", self.stir_obj.estimated_avian_inhalation_ld50, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.estimated_avian_inhalation_ld50, 3), testFailureMessage)
...
class TestCase_adjusted_avian_inhalation_ld50(unittest.TestCase):
    ...
    def testadjusted_avian_inhalation_ld50_in(self):
        out_fun_adjusted_avian_inhalation_ld50.append(
            self.stir_obj.adjusted_avian_inhalation_ld50)
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "adjusted_avian_inhalation_ld50", self.stir_obj.adjusted_avian_inhalation_ld50, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.adjusted_avian_inhalation_ld50, 3), testFailureMessage)
...
class TestCase_ratio_vid_avian(unittest.TestCase):
    ...
    def testratio_vid_avian_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "ratio_vid_avian", self.stir_obj.ratio_vid_avian, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.ratio_vid_avian, 3), testFailureMessage)
...
class TestCase_ratio_sid_avian(unittest.TestCase):
    ...
    def testratio_sid_avian_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "ratio_sid_avian", self.stir_obj.ratio_sid_avian, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.ratio_sid_avian, 3), testFailureMessage)
...
class TestCase_ratio_vid_mammal(unittest.TestCase):
    ...
    def testratio_vid_mammal_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "ratio_vid_mammal", self.stir_obj.ratio_vid_mammal, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.ratio_vid_mammal, 3), testFailureMessage)
...
class TestCase_ratio_sid_mammal(unittest.TestCase):
    ...
    def testratio_sid_mammal_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "ratio_sid_mammal", self.stir_obj.ratio_sid_mammal, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.ratio_sid_mammal, 3), testFailureMessage)
...
class TestCase_loc_vid_avian(unittest.TestCase):
    ...
    def testloc_vid_avian_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "loc_vid_avian", self.stir_obj.loc_vid_avian, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.loc_vid_avian, 3), testFailureMessage)
...
class TestCase_loc_sid_avian(unittest.TestCase):
    ...
    def testloc_sid_avian_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "loc_sid_avian", self.stir_obj.loc_sid_avian, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.loc_sid_avian, 3), testFailureMessage)
...
class TestCase_loc_vid_mammal(unittest.TestCase):
    ...
    def testloc_vid_mammal_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "loc_vid_mammal", self.stir_obj.loc_vid_mammal, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.loc_vid_mammal, 3), testFailureMessage)
...
class TestCase_loc_sid_mammal(unittest.TestCase):
    ...
    def testloc_sid_mammal_in(self):
        ...
        testFailureMessage = "Test of function name: %s expected: %s != calculated: %s" % (
            "loc_sid_mammal", self.stir_obj.loc_sid_mammal, fun)
        self.assertEqual(
            round(
                fun, 3), round(
                self.loc_sid_mammal, 3), testFailureMessage)
...
stir_obj = stir_model.StirModel(
    ...
    application_rate[0],
    column_height[0],
    spray_drift_fraction[0],
    direct_spray_duration[0],
    molecular_weight[0],
    vapor_pressure[0],
    avian_oral_ld50[0],
    body_weight_assessed_bird[0],
    body_weight_tested_bird[0],
    mineau_scaling_factor[0],
    mammal_inhalation_lc50[0],
    duration_mammal_inhalation_study[0],
    body_weight_assessed_mammal[0],
    body_weight_tested_mammal[0],
    mammal_oral_ld50[0])
...
stir_obj.adjusted_mammal_inhalation_ld50_expected = adjusted_mammal_inhalation_ld50[
    0]
stir_obj.estimated_avian_inhalation_ld50_expected = estimated_avian_inhalation_ld50[
    0]
stir_obj.adjusted_avian_inhalation_ld50_expected = adjusted_avian_inhalation_ld50[
    0]
...
test_suite_mammal_inhalation_ld50 = suite(
    TestCase_mammal_inhalation_ld50,
    stir_obj=stir_obj)
test_suite_adjusted_mammal_inhalation_ld50 = suite(
    TestCase_adjusted_mammal_inhalation_ld50,
    stir_obj=stir_obj)
test_suite_estimated_avian_inhalation_ld50 = suite(
    TestCase_estimated_avian_inhalation_ld50,
    stir_obj=stir_obj)
test_suite_adjusted_avian_inhalation_ld50 = suite(
    TestCase_adjusted_avian_inhalation_ld50,
    stir_obj=stir_obj)
...
test_suite_ratio_vid_mammal = suite(
    TestCase_ratio_vid_mammal,
    stir_obj=stir_obj)
test_suite_ratio_sid_mammal = suite(
    TestCase_ratio_sid_mammal,
    stir_obj=stir_obj)

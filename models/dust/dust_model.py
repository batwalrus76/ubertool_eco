...
class dust(object):
    ...
    def set_variables(
        ...
        all_dic = {
            ...
            "label_epa_reg_no": self.label_epa_reg_no,
            "ar_lb": self.ar_lb,
            "frac_pest_surface": self.frac_pest_surface,
            "dislodge_fol_res": self.dislodge_fol_res,
            "bird_acute_oral_study": self.bird_acute_oral_study,
            "bird_study_add_comm": self.bird_study_add_comm,
            "low_bird_acute_ld50": self.low_bird_acute_ld50,
            "test_bird_bw": self.test_bird_bw,
            "mineau_scaling_factor": self.mineau_scaling_factor,
            "mamm_acute_derm_study": self.mamm_acute_derm_study,
            "mamm_study_add_comm": self.mamm_study_add_comm,
            "mam_acute_derm_ld50": self.mam_acute_derm_ld50,
            "mam_acute_oral_ld50": self.mam_acute_oral_ld50,
            "test_mam_bw": self.test_mam_bw}

...
# low_bird_acute_ld50, test_bird_bw, mineau_scaling_factor,
# mamm_acute_derm_study, mamm_study_add_comm, mam_acute_derm_ld50,
# mam_acute_oral_ld50, test_mam_bw, None)

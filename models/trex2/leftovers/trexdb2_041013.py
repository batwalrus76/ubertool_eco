...
Applicationtype_CHOICES = (
    ...
    ('Seed Treatment',
     'Seed Treatment'))
Applicationtarget_CHOICES = (
    ('Short grass',
     'Short grass'),
    ('Tall grass',
     'Tall grass'),
    ('Broad-leafed plants/small insects',
     'Broad-leafed plants/small insects'),
    ('Fruits/pods/seeds',
     'Fruits/pods/seeds'),
    ('Insects',
...
seed_crop_CHOICES = (
    ...
    ('104.5',
     'soybean for edamame'),
    ('157.1',
     'wheat, all or unspecified'),
    ('157',
     'wheat, winter'),
    ('156',
     'wheat, spring'),
    ('120',
     'wheat, hard red winter, dryland'),
    ('130',
     'wheat, hard red winter, irrigated'),
    ('130',
     'wheat, hard red winter, unspecified'),
    ('157.1',
     'wheat, soft red winter, all'),
    ('120',
     'wheat, hard red spring, dryland'),
    ('146',
     'wheat, hard red spring, irrigated'),
    ('146',
     'wheat, hard red spring, unspecified'),
    ('156',
     'wheat, white'),
    ('156',
     'wheat, durum'),
    ('116',
     'hay or pasture, all or unspecified'),
    ('35',
     'perennial legume hay or pasture'),
    ('90',
     'alfalfa'),
    ('15',
     'birdsfoot trefoil'),
    ...
    ('5',
     'crown vetch'),
    ('30',
     'perennial grass hay or pasture'),
    ('30',
     'festulolium'),
    ('25',
     'Kentucky bluegrass'),
    ...
    ('12',
     'switch grass'),
    ('116',
     'annual grass for forage'),
    ('9',
     'annual ryegrass'),
    ('24',
     'pearl millet for forage'),
    ('20',
     'oats spring, for forage'),
    ('87',
     'rye, winter for forage'),
    ('109',
     'sorghum for forage'),
    ('24',
    ...
    ('100',
     'kale for market'),
    ('0.98',
     'lettuce, all or unspecifed'),
    ('0.78',
     'lettuce, head'),
    ('0.39',
     'lettuce, leaf, Bibb, Boston, or Romaine'),
    ('71',
     'millet for feed, all or unspecified'),
    ('71',
     'millet for feed, browntop'),
    ('20',
     'millet for feed, finger'),
    ('10',
     'millet for feed, foxtail'),
    ('20',
     'millet for feed, Japanese'),
    ('25',
     'millet for feed, pearl'),
    ('15',
     'millet for feed, proso'),
    ('0.8',
     'musk melon, all or unspecified'),
    ('0.8',
     'canteloupe'),
    ('0.8',
     'honeydew'),
    ...
    ('7',
     'oats'),
    ('110',
     'onions, all or unspecified'),
    ('75',
     'onions, bulb types except pearl'),
    ('110',
     'onions, pearl'),
    ('4.59',
     'onions for seed'),
    ('75',
     'onions, bunching (spring or green)'),
    ('40',
     'parsley'),
    ('217.8',
     'pea, field'),
    ...
    ('170',
     'peppers, bell'),
    ('4.18',
     'peppers, hot (paprika, chili, etc)'),
    ('6969.6',
     'potatoes'),
    ('4.54',
     'pumpkin, all'),
    ('4.54',
     'pumpkin, large or large vine'),
    ('4.54',
     'pumpkin, bush or small fruit/vine'),
    ('8.01',
     'squash, all'),
    ('6.1',
     'squash, summer'),
    ...
    ('60.31',
     'spinach'),
    ('25',
     'sugar beet for seed production'),
    ('25',
     'sugar beet'),
    ('1.82',
     'sunflower'),
...
Species_of_the_tested_bird_CHOICES = (
    ('178', 'Bobwhite quail'), ('1580', 'Mallard duck'), ('', 'Other'))
...
class trexInp(forms.Form):
   ...
   #Application_type = forms.MultipleChoiceField(required=True, choices=Applicationtype_CHOICES, widget=forms.CheckboxSelectMultiple)
    ...
    maximum_seedling_rate_per_use = forms.FloatField(
        required=True,
        label='Maximum seeding rate per use (lbs/A)',
        initial=100)
...
class trexAnimal(forms.Form):
   ...
   # Bird_type = forms.CharField(required=True, choices=_Bird_type, initial='Herbivores and insectivores')
    ...
    body_weight_of_the_tested_bird = forms.FloatField(
        required=True,
        label='Body weight of the tested bird (g)',
        initial=get_STB_choices(Species_of_the_tested_bird))

...
class trexInp(forms.Form):
   ...
   #Application_type = forms.MultipleChoiceField(required=True, choices=Applicationtype_CHOICES, widget=forms.CheckboxSelectMultiple)
    ...
    application_rate = forms.FloatField(
        required=True,
        label='Granular application rate (lbs a.i./A)',
        initial=4)
    application_rate_l = forms.FloatField(
        required=True,
        label='Liquid application rate (fl oz/A)',
        initial=36)  # only for LD50-2,
    ...
    maximum_seedling_rate_per_use = forms.FloatField(
        ...
        initial=100)
    application_rate_per_use = forms.FloatField(
        required=True,
        label='Application rate per use (fl oz/cwt)',
        initial=36)
    ...
    body_weight_of_the_assessed_bird = forms.FloatField(
        required=True,
...
#
    ...
    body_weight_of_the_assessed_mammal = forms.FloatField(
        required=True,

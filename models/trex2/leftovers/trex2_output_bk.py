...
#           mf_w_bird=0.1
        ...
        html = html + trex2_tables.table_1(chem_name,
                                           use,
                                           formu_name,
                                           100 * a_i,
                                           Application_type,
        ...
        if Application_type == 'Seed Treatment':
            ...
            html = html + """<table width="600" border="1">
                        ...
                        """ % (trex2_model.ARQ_dose_bird(
                trex2_model.EEC_dose_bird,
                trex2_model.EEC_diet,
                aw_bird_sm,
                trex2_model.fi_bird,
                trex2_model.at_bird,

...
class trex2(object):
    ...
    def __init__(
        ...
        all_dic = {
            ...
            "use": self.use,
            "formu_name": self.formu_name,
            "a_i": self.a_i,
            "Application_type": self.Application_type,
            "seed_treatment_formulation_name": self.seed_treatment_formulation_name,
            "seed_crop": self.seed_crop,
            "seed_crop_v": self.seed_crop_v,
            "r_s": self.r_s,
            "b_w": self.b_w,
            "p_i": self.p_i,
            "den": self.den,
            ...
            "ld50_bird": self.ld50_bird,
            "lc50_bird": self.lc50_bird,
            "NOAEC_bird": self.NOAEC_bird,
            "NOAEL_bird": self.NOAEL_bird,
            "aw_bird_sm": self.aw_bird_sm,
            "aw_bird_md": self.aw_bird_md,
            "aw_bird_lg": self.aw_bird_lg,
            "Species_of_the_tested_bird_avian_ld50": self.Species_of_the_tested_bird_avian_ld50,
            "Species_of_the_tested_bird_avian_lc50": self.Species_of_the_tested_bird_avian_lc50,
            "Species_of_the_tested_bird_avian_NOAEC": self.Species_of_the_tested_bird_avian_NOAEC,
            "Species_of_the_tested_bird_avian_NOAEL": self.Species_of_the_tested_bird_avian_NOAEL,
            "tw_bird_ld50": self.tw_bird_ld50,
            "tw_bird_lc50": self.tw_bird_lc50,
            "tw_bird_NOAEC": self.tw_bird_NOAEC,
            "tw_bird_NOAEL": self.tw_bird_NOAEL,
            "x": self.x,
            "ld50_mamm": self.ld50_mamm,
            "lc50_mamm": self.lc50_mamm,
            "NOAEC_mamm": self.NOAEC_mamm,
            "NOAEL_mamm": self.NOAEL_mamm,
            "aw_mamm_sm": self.aw_mamm_sm,
            "aw_mamm_md": self.aw_mamm_md,
            "aw_mamm_lg": self.aw_mamm_lg,
            "tw_mamm": self.tw_mamm,
            "m_s_r_p": self.m_s_r_p}

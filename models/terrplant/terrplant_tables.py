...
def getheaderplantecdrysemisprayqaqc():
    headings = [
        ...
        "Dry-Expected",
        "Semi-Aquatic",
        "Semi-Aquatic-Expected",
        "Spray Drift",
        "Spray Drift-Expected"]
    return headings
...
def gett1data(terrplant_obj):
    data = {
        ...
        "Value": [
            ...
            terrplant_obj.pc_code,
            terrplant_obj.use,
            terrplant_obj.application_method,
            terrplant_obj.application_form,
        ],
    }
    return data
...
def gett1dataqaqc(terrplant_obj):
    data = {
        ...
        "Value": [
            terrplant_obj.chemical_name_expected,
            terrplant_obj.pc_code_expected,
            terrplant_obj.use_expected,
            terrplant_obj.application_method_expected,
            terrplant_obj.application_form_expected,
        ],
    }
    return data
...
def gett3data(terrplant_obj):
    data = {
        "Description": [
            ...
            'Spray Drift',
            'Total to Dry Areas',
            'Total to Semi-Aquatic Areas',
        ],
        "EEC": [
            '%.2f' %
            terrplant_obj.rundry_results,
            '%.2f' %
            terrplant_obj.runsemi_results,
            '%.2f' %
            terrplant_obj.spray_results,
            '%.2f' %
            terrplant_obj.totaldry_results,
            '%.2f' %
            terrplant_obj.totalsemi_results,
        ],
    }
    return data
...
def gett5data(terrplant_obj):
    data = {
        ...
        "Dry": [
            '%.2f' %
            terrplant_obj.nmsRQdry_results,
            '%.2f' %
            terrplant_obj.lmsRQdry_results,
            '%.2f' %
            terrplant_obj.ndsRQdry_results,
            '%.2f' %
            terrplant_obj.ldsRQdry_results,
        ],
        "Semi-Aquatic": [
            '%.2f' %
            terrplant_obj.nmsRQsemi_results,
            '%.2f' %
            terrplant_obj.lmsRQsemi_results,
            '%.2f' %
            terrplant_obj.ndsRQsemi_results,
            '%.2f' %
            terrplant_obj.ldsRQsemi_results,
        ],
        "Spray Drift": [
            '%.2f' %
            terrplant_obj.nmsRQspray_results,
            '%.2f' %
            terrplant_obj.lmsRQspray_results,
            '%.2f' %
            terrplant_obj.ndsRQspray_results,
            '%.2f' %
            terrplant_obj.ldsRQspray_results,
        ],
    }
    return data
...
def gett5dataqaqc(terrplant_obj):
    data = {
        "Plant Type": [
            'Monocot', 'Monocot', 'Dicot', 'Dicot', ], "Listed Status": [
            'non-listed', 'listed', 'non-listed', 'listed', ], "Dry": [
                '%.2f' %
                terrplant_obj.nmsRQdry_results, '%.2f' %
                terrplant_obj.lmsRQdry_results, '%.2f' %
                terrplant_obj.ndsRQdry_results, '%.2f' %
                terrplant_obj.ldsRQdry_results, ], "Dry-Expected": [
                    '%.2f' %
                    terrplant_obj.nmsRQdry_results_expected, '%.2f' %
                    terrplant_obj.lmsRQdry_results_expected, '%.2f' %
                    terrplant_obj.ndsRQdry_results_expected, '%.2f' %
                    terrplant_obj.ldsRQdry_results_expected, ], "Semi-Aquatic": [
                        '%.2f' %
                        terrplant_obj.nmsRQsemi_results, '%.2f' %
                        terrplant_obj.lmsRQsemi_results, '%.2f' %
                        terrplant_obj.ndsRQsemi_results, '%.2f' %
                        terrplant_obj.ldsRQsemi_results, ], "Semi-Aquatic-Expected": [
                            '%.2f' %
                            terrplant_obj.nmsRQsemi_results_expected, '%.2f' %
                            terrplant_obj.lmsRQsemi_results_expected, '%.2f' %
                            terrplant_obj.ndsRQsemi_results_expected, '%.2f' %
                            terrplant_obj.ldsRQsemi_results_expected, ], "Spray Drift": [
                                '%.2f' %
                                terrplant_obj.nmsRQspray_results, '%.2f' %
                                terrplant_obj.lmsRQspray_results, '%.2f' %
                                terrplant_obj.ndsRQspray_results, '%.2f' %
                                terrplant_obj.ldsRQspray_results, ], "Spray Drift-Expected": [
                                    '%.2f' %
                                    terrplant_obj.nmsRQspray_results_expected, '%.2f' %
                                    terrplant_obj.lmsRQspray_results_expected, '%.2f' %
                                    terrplant_obj.ndsRQspray_results_expected, '%.2f' %
            terrplant_obj.ldsRQspray_results_expected, ], }
    return data
...
def gettsumdata(A, I, R, D, nms, lms, nds, lds):
    data = {
        "Parameter": [
            ...
            'Drift Fraction',
            'Runoff Fraction',
            'Noaec for listed seedling emergence monocot',
            'Ec25 for nonlisted seedling emergence monocot',
            'Noaec for listed seedling emergence dicot',
            'Noaec for listed seedling emergence dicot'],
        "Mean": [
            '%.2e' %
            numpy.mean(A),
...
def gettsumdata_out(
    ...
    data = {
        ...
        "Mean": [
            '%.2e' %
            numpy.mean(rundry_out),
            '%.2e' %
            numpy.mean(runsemi_out),
            '%.2e' %
            numpy.mean(spray_out),
            '%.2e' %
            numpy.mean(totaldry_out),
            '%.2e' %
            numpy.mean(totaldry_out),
            '%.2e' %
            numpy.mean(nmsRQdry_out),
            '%.2e' %
            numpy.mean(nmsRQsemi_out),
            '%.2e' %
            numpy.mean(nmsRQspray_out),
            '%.2e' %
            numpy.mean(lmsRQdry_out),
            '%.2e' %
            numpy.mean(lmsRQsemi_out),
            '%.2e' %
            numpy.mean(lmsRQspray_out),
            '%.2e' %
            numpy.mean(ndsRQdry_out),
            '%.2e' %
            numpy.mean(ndsRQsemi_out),
            '%.2e' %
            numpy.mean(ndsRQspray_out),
            '%.2e' %
            numpy.mean(ldsRQdry_out),
            '%.2e' %
            numpy.mean(ldsRQsemi_out),
            '%.2e' %
            numpy.mean(ldsRQspray_out),
        ],
        "Std": [
            '%.2e' %
            numpy.std(rundry_out),
            '%.2e' %
            numpy.std(runsemi_out),
            '%.2e' %
            numpy.std(spray_out),
            '%.2e' %
            numpy.std(totaldry_out),
            '%.2e' %
            numpy.std(totaldry_out),
            '%.2e' %
            numpy.std(nmsRQdry_out),
            '%.2e' %
            numpy.std(nmsRQsemi_out),
            '%.2e' %
            numpy.std(nmsRQspray_out),
            '%.2e' %
            numpy.std(lmsRQdry_out),
            '%.2e' %
            numpy.std(lmsRQsemi_out),
            '%.2e' %
            numpy.std(lmsRQspray_out),
            '%.2e' %
            numpy.std(ndsRQdry_out),
            '%.2e' %
            numpy.std(ndsRQsemi_out),
            '%.2e' %
            numpy.std(ndsRQspray_out),
            '%.2e' %
            numpy.std(ldsRQdry_out),
            '%.2e' %
            numpy.std(ldsRQsemi_out),
            '%.2e' %
            numpy.std(ldsRQspray_out),
        ],
        "Min": [
            '%.2e' %
            numpy.min(rundry_out),
            '%.2e' %
            numpy.min(runsemi_out),
            '%.2e' %
            numpy.min(spray_out),
            '%.2e' %
            numpy.min(totaldry_out),
            '%.2e' %
            numpy.min(totaldry_out),
            '%.2e' %
            numpy.min(nmsRQdry_out),
            '%.2e' %
            numpy.min(nmsRQsemi_out),
            '%.2e' %
            numpy.min(nmsRQspray_out),
            '%.2e' %
            numpy.min(lmsRQdry_out),
            '%.2e' %
            numpy.min(lmsRQsemi_out),
            '%.2e' %
            numpy.min(lmsRQspray_out),
            '%.2e' %
            numpy.min(ndsRQdry_out),
            '%.2e' %
            numpy.min(ndsRQsemi_out),
            '%.2e' %
            numpy.min(ndsRQspray_out),
            '%.2e' %
            numpy.min(ldsRQdry_out),
            '%.2e' %
            numpy.min(ldsRQsemi_out),
            '%.2e' %
            numpy.min(ldsRQspray_out),
        ],
        "Max": [
            '%.2e' %
            numpy.max(rundry_out),
            '%.2e' %
            numpy.max(runsemi_out),
            '%.2e' %
            numpy.max(spray_out),
            '%.2e' %
            numpy.min(totaldry_out),
            ...
            numpy.min(totaldry_out),
            '%.2e' %
            numpy.max(nmsRQdry_out),
            '%.2e' %
            numpy.max(nmsRQsemi_out),
            '%.2e' %
            numpy.min(nmsRQspray_out),
            '%.2e' %
            numpy.max(lmsRQdry_out),
            '%.2e' %
            numpy.max(lmsRQsemi_out),
            '%.2e' %
            numpy.min(lmsRQspray_out),
            '%.2e' %
            numpy.max(ndsRQdry_out),
            '%.2e' %
            numpy.max(ndsRQsemi_out),
            '%.2e' %
            numpy.min(ndsRQspray_out),
            '%.2e' %
            numpy.max(ldsRQdry_out),
            '%.2e' %
            numpy.max(ldsRQsemi_out),
            '%.2e' %
            numpy.min(ldsRQspray_out),
        ],
        "Unit": [
...
def table_all_sum(
    ...
    html_all_sum = table_sum_input(
        ...
        nds,
        lds)
    html_all_sum += table_sum_output(sumheadings,
                                     tmpl,
                                     rundry_out,
                                     runsemi_out,
                                     spray_out,
...
def table_4(terrplant_obj):
    ...
    html = html + \
        tmpl.render(Context(dict(data=t4rows, headings=plantec25noaecheadings)))
    html = html + """
                </div>
        """
    return html
...
def table_5(terrplant_obj):
    ...
    html = html + \
        tmpl.render(Context(dict(data=t5rows, headings=plantecdrysemisprayheadings)))
    html = html + """

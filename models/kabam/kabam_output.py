...
#        body_weight_of_the_assessed_mamm = float(request.POST.get('bw_assess_m'))
    ...
    lf_p_benthic_invertebrates = float(
        request.POST.get('lfish_p_beninv')) / 100
    ...
    mf_p_benthic_invertebrates = float(
        request.POST.get('mfish_p_beninv')) / 100
    ...
    sf_p_benthic_invertebrates = float(
        request.POST.get('sfish_p_beninv')) / 100
    ...
    # cb_phytoplankton_v,cb_zoo_v,cb_beninv_v,cb_ff_v,cb_sf_v,cb_mf_v,cb_lf_v
    # ***Removed from kabam_obj above***

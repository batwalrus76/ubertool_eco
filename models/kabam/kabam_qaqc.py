...
kabam_obj = kabam_model.kabam(
    ...
    mammalian_ld50[0],
    mammalian_lc50[0],
    mammalian_chronic_endpoint[0],
    lf_p_sediment[0],
    lf_p_phytoplankton[0],
    lf_p_zooplankton[0],
    lf_p_benthic_invertebrates[0],
    lf_p_filter_feeders[0],
    lf_p_small_fish[0],
    lf_p_medium_fish[0],
    mf_p_sediment[0],
    mf_p_phytoplankton[0],
    mf_p_zooplankton[0],
    mf_p_benthic_invertebrates[0],
    mf_p_filter_feeders[0],
    mf_p_small_fish[0],
    sf_p_sediment[0],
    sf_p_phytoplankton[0],
    sf_p_zooplankton[0],
    sf_p_benthic_invertebrates[0],
    sf_p_filter_feeders[0],
    ff_p_sediment[0],
    ff_p_phytoplankton[0],
    ff_p_zooplankton[0],
    ff_p_benthic_invertebrates[0],
    beninv_p_sediment[0],
    beninv_p_phytoplankton[0],
    beninv_p_zooplankton[0],
    zoo_p_sediment[0],
    zoo_p_phyto[0],
    s_lipid[0],
    s_NLOM[0],
    s_water[0],
    v_lb_phytoplankton[0],
    v_nb_phytoplankton[0],
    v_wb_phytoplankton[0],
    wb_zoo[0],
    v_lb_zoo[0],
    v_nb_zoo[0],
    v_wb_zoo[0],

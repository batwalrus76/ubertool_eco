...
class kabam(object):
    ...
    def __init__(
            ...
            mammalian_ld50=1,
            mammalian_lc50=1,
            mammalian_chronic_endpoint=1,
            lf_p_sediment=1,
            lf_p_phytoplankton=1,
            lf_p_zooplankton=1,
            lf_p_benthic_invertebrates=1,
            lf_p_filter_feeders=1,
            lf_p_small_fish=1,
            lf_p_medium_fish=1,
            mf_p_sediment=1,
            mf_p_phytoplankton=1,
            mf_p_zooplankton=1,
            mf_p_benthic_invertebrates=1,
            mf_p_filter_feeders=1,
            mf_p_small_fish=1,
            sf_p_sediment=1,
            sf_p_phytoplankton=1,
            sf_p_zooplankton=1,
            sf_p_benthic_invertebrates=1,
            sf_p_filter_feeders=1,
            ff_p_sediment=1,
            ff_p_phytoplankton=1,
            ff_p_zooplankton=1,
            ff_p_benthic_invertebrates=1,
            beninv_p_sediment=1,
            beninv_p_phytoplankton=1,
            beninv_p_zooplankton=1,
            zoo_p_sediment=1,
            zoo_p_phyto=1,
            s_lipid=1,
            s_NLOM=1,
            s_water=1,
            v_lb_phytoplankton=1,
            v_nb_phytoplankton=1,
            v_wb_phytoplankton=1,
            wb_zoo=1,
            v_lb_zoo=1,
            v_nb_zoo=1,
            v_wb_zoo=1,
            ...
            # cb_phytoplankton_v=1,cb_zoo_v=1,cb_beninv_v=1,cb_ff_v=1,cb_sf_v=1,cb_mf_v=1,cb_lf_v=1,
            # ***These were removed from __init__***
        ...
        if set_variables:
            if vars_dict is not None:
                ...
                all_dic = {
                    ...
                    "k_oc": k_oc,
                    "c_wdp": c_wdp,
                    "water_column_EEC": water_column_EEC,
                    "c_wto": c_wto,
                    "mineau_scaling_factor": mineau_scaling_factor,
                    "x_poc": x_poc,
                    "x_doc": x_doc,
                    "c_ox": c_ox,
                    "w_t": w_t,
                    ...
                    "oc": oc,
                    "k_ow": k_ow,
                    "Species_of_the_tested_bird": Species_of_the_tested_bird,
                    "bw_quail": bw_quail,
                    "bw_duck": bw_duck,
                    "bwb_other": bwb_other,
                    "avian_ld50": avian_ld50,
                    "avian_lc50": avian_lc50,
                    "avian_noaec": avian_noaec,
                    "m_species": m_species,
                    "bw_rat": bw_rat,
                    "bwm_other": bwm_other,
                    "mammalian_ld50": mammalian_ld50,
                    "mammalian_lc50": mammalian_lc50,
                    "mammalian_chronic_endpoint": mammalian_chronic_endpoint,
                    "lf_p_sediment": lf_p_sediment,
                    "lf_p_phytoplankton": lf_p_phytoplankton,
                    "lf_p_zooplankton": lf_p_zooplankton,
                    "lf_p_benthic_invertebrates": lf_p_benthic_invertebrates,
                    "lf_p_filter_feeders": lf_p_filter_feeders,
                    "lf_p_small_fish": lf_p_small_fish,
                    "lf_p_medium_fish": lf_p_medium_fish,
                    "mf_p_sediment": mf_p_sediment,
                    "mf_p_phytoplankton": mf_p_phytoplankton,
                    "mf_p_zooplankton": mf_p_zooplankton,
                    "mf_p_benthic_invertebrates": mf_p_benthic_invertebrates,
                    "mf_p_filter_feeders": mf_p_filter_feeders,
                    "mf_p_small_fish": mf_p_small_fish,
                    "sf_p_sediment": sf_p_sediment,
                    "sf_p_phytoplankton": sf_p_phytoplankton,
                    "sf_p_zooplankton": sf_p_zooplankton,
                    "sf_p_benthic_invertebrates": sf_p_benthic_invertebrates,
                    "sf_p_filter_feeders": sf_p_filter_feeders,
                    "ff_p_sediment": ff_p_sediment,
                    "ff_p_phytoplankton": ff_p_phytoplankton,
                    "ff_p_zooplankton": ff_p_zooplankton,
                    "ff_p_benthic_invertebrates": ff_p_benthic_invertebrates,
                    "beninv_p_sediment": beninv_p_sediment,
                    "beninv_p_phytoplankton": beninv_p_phytoplankton,
                    "beninv_p_zooplankton": beninv_p_zooplankton,
                    "zoo_p_sediment": zoo_p_sediment,
                    "zoo_p_phyto": zoo_p_phyto,
                    "s_lipid": s_lipid,
                    "s_NLOM": s_NLOM,
                    "s_water": s_water,
                    "v_lb_phytoplankton": v_lb_phytoplankton,
                    "v_nb_phytoplankton": v_nb_phytoplankton,
                    "v_wb_phytoplankton": v_wb_phytoplankton,
                    "wb_zoo": wb_zoo,
                    "v_lb_zoo": v_lb_zoo,
                    "v_nb_zoo": v_nb_zoo,
                    "v_wb_zoo": v_wb_zoo,
                    "wb_beninv": wb_beninv,
                    "v_lb_beninv": v_lb_beninv,
                    "v_nb_beninv": v_nb_beninv,
                    "v_wb_beninv": v_wb_beninv,
                    "wb_ff": wb_ff,
                    "v_lb_ff": v_lb_ff,
                    "v_nb_ff": v_nb_ff,
                    "v_wb_ff": v_wb_ff,
                    ...
                    "v_nb_lf": v_nb_lf,
                    "v_wb_lf": v_wb_lf,
                    "kg_phytoplankton": kg_phytoplankton,
                    "kd_phytoplankton": kd_phytoplankton,
                    "ke_phytoplankton": ke_phytoplankton,
                    "mo_phytoplankton": mo_phytoplankton,
                    "mp_phytoplankton": mp_phytoplankton,
                    "km_phytoplankton": km_phytoplankton,
                    "km_zoo": km_zoo,
                    "k1_phytoplankton": k1_phytoplankton,
                    "k2_phytoplankton": k2_phytoplankton,
                    "k1_zoo": k1_zoo,
                    "k2_zoo": k2_zoo,
                    "kd_zoo": kd_zoo,
                    "ke_zoo": ke_zoo,
                    ...
                    "s_respire": s_respire,
                    "phyto_respire": phyto_respire,
                    "zoo_respire": zoo_respire,
                    "beninv_respire": beninv_respire,
                    "ff_respire": ff_respire,
                    "sfish_respire": sfish_respire,
                    "mfish_respire": mfish_respire,
                    "lfish_respire": lfish_respire}
                ...
                output_val = json.loads(
                    response.content,
                    cls=rest_funcs.NumPyDecoder)['result']
                output_val_uni = json.loads(
                    output_val,
                    cls=rest_funcs.NumPyDecoder)

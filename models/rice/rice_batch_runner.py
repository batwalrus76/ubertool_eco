    ...
    def runRiceModel(self, config_properties):
        ...
        if 'application_kg_rate' in config_properties:
            if 'area_of_the_rice_paddy' in config_properties:
                riceModelResults['mai1'] = rice_model.mai1(
                    config_properties['application_kg_rate'],
                    config_properties['area_of_the_rice_paddy'])
                            ...
                            if 'porosity_of_sediment' in config_properties:
                                if 'bulk_density_of_sediment' in config_properties:
                                    if 'Kd' in config_properties:
                                        riceModelResults['cw'] = rice_model.cw(
                                            riceModelResults['mai1'],
                                            config_properties['water_column_depth'],
                                            config_properties['sediment_depth'],
                                            config_properties['porosity_of_sediment'],
                                            config_properties['bulk_density_of_sediment'],
                                            config_properties['Kd'])

...
def gett1data(rice_obj):
    data = {
        ...
        "Units": [
            '',
            'kg',
            mark_safe('m<sup>2</sup>'),
            'm',
            mark_safe('kg/m<sup>3</sup>'),
            'm',
            '',
            'L/kg'],
    }
...
def gett1dataqaqc(rice_obj):
    data = {
        ...
        "Value": [
            ...
            rice_obj.kd],
        "Expected-Value": [
            rice_obj.chemical_name_expected,
            rice_obj.mai,
            rice_obj.a,
            rice_obj.dsed,
            rice_obj.pb,
...
def gett2dataqaqc(rice_obj):
    data = {
        ...
        "Expected-Value": [
            '%.2f' %
            rice_obj.msed_expected,
            '%.2f' %
            rice_obj.vw_expected,
            '%.4f' %
            rice_obj.mai1_expected,
            '%.4f' %
            rice_obj.cw_expected,
        ],
        "Units": [
            'kg',
            mark_safe('m<sup>3</sup>'),
...
def table_1_qaqc(rice_obj):
    ...
    html = html + \
        tmpl.render(Context(dict(data=t1rows, headings=pvuheadingsqaqc)))
    html = html + """
                </div>
        </div>
        """

...
def trexOutputPage(request):
    ...
    a_r_l = float(a_r_l)
    seed_treatment_formulation_name = request.POST.get(
...
#           mf_w_bird=0.1
    ...
    """ % ( a_t,
            ...
            trex_model.ARQ_dose_mamm_g(
                ...
                h_l),
            a_t,
            trex_model.CRQ_dose_mamm(
                trex_model.EEC_diet,
                trex_model.EEC_dose_mamm,
                trex_model.ANOAEL_mamm,
                NOAEL_mamm,
                aw_mamm,
                tw_mamm,
                0.8,

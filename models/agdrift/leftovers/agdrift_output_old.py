...
class agdriftOutputPage(webapp.RequestHandler):
    ...
    def post(self):
        ...
        """ % (results[0], results[1])
        html = html + \
            template.render(templatepath + 'agdrift-output-jqplot.html', {})
        html = html +  """
        </div>
        """
        html = html + template.render(templatepath + 'export.html', {})
        html = html + \
            template.render(templatepath + '04uberoutput_end.html', {})
        html = html + \

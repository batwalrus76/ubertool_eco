...
Drop_size_distribution_CHOICES = (
    ('0',
     'Make a selection'),
    ('Fine',
     'Very fine to fine'),
...
Boom_height_CHOICES = (
    ('0', 'Make a selection'), ('Low', 'Low'), ('High', 'High'))
Ecosystem_type_CHOICES = (
    ...
    ('EPA Pond',
     'Aquatic Assessment'),
    ('Terrestrial',
     'Terrestrial Assessment'))  # Aquatic Assessment
...
# Waterbody_type_CHOICES=(('','Make a selection'),('EPA Pond','EPA
# Pond'),('Lake', 'Lake'), ('Watercourse', 'Watercourse')) #Aquatic
# Assessment
Orchard_CHOICES = (
    ('0',
     'Make a selection'),
...
Calculation_input_CHOICES = (
    ('0',
     'Make a selection'),
    ('Distance',
     'Distance to waterbody or field'),
    ('Fraction',
     'Fraction of applied'),
    ('Initial Average Deposition (g/ha)',
     'Initial Average Deposition (g/ha)'),
    ('Initial Average Deposition (lb/ac)',
     'Initial Average Deposition (lb/ac)'),
    ('Initial Average Concentration (ng/L)',
     'Initial Average Concentration (ng/L)'),
    ('Initial Average Deposiion (mg/cm2)',
...
class AgdriftInp(forms.Form):
    #    waterbody_type = forms.ChoiceField(
            ...
            # choices=Waterbody_type_CHOICES,initial='Make a selection')
...
#    extending_settings = forms.ChoiceField(
    # label='Optional settings', choices=Extended_settings_CHOICES,
    # initial='Make a selection')

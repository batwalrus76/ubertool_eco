    ...
    if xdepth or ydepth:
        if y0 != yhigh:  # non-zero height
            _add_3d_bar(
                ...
                xdepth,
                ydepth,
                fillColor=fillColorShaded)  # side
        ...
        _add_3d_bar(
            ...
            xdepth,
            ydepth,
            fillColor=fillColorShadedTop)  # top
...
def _make_3d_line_info(
    ...
    c = slope > depth_slope and _getShaded(
        fillColor,
        fillColorShaded,
...
if __name__ == '__main__':
    ...
    print(find_intersections([[(0, 0.5), (1, 0.5), (0.5, 0), (0.5, 1)], [
          (.2666666667, 0.4), (0.1, 0.4), (0.1, 0.2), (0, 0), (1, 1)], [(0, 1), (0.4, 0.1), (1, 0.1)]]))
    print(find_intersections([[(0.1, 0.2), (0.1, 0.4)], [(0, 1), (0.4, 0.1)]]))
    print(find_intersections(
        [[(0.2, 0.4), (0.1, 0.4)], [(0.1, 0.8), (0.4, 0.1)]]))
    print(find_intersections([[(0, 0), (1, 1)], [(0.4, 0.1), (1, 0.1)]]))
    print(find_intersections([[(0, 0.5), (1, 0.5), (0.5, 0), (0.5, 1)], [
          (0, 0), (1, 1)], [(0.1, 0.8), (0.4, 0.1), (1, 0.1)]]))

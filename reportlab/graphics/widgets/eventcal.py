...
class EventCalendar(Widget):
    ...
    def computeStartAndEndTimes(self):
        ...
        if self.startTime:
            ...
            for (
                    ...
                    day,
                    start,
                    duration) in self._talksVisible:
    ...
    def scaleTime(self, theTime):
        ...
        proportionUp = (
            (theTime - self._startTime) / (self._endTime - self._startTime))
...
def test():
    ...
    cal.data = [
        ...
        ('lunch, short presentations, vendor presentations',
         '',
         None,
         1,
         12.0,
        ...
        ("Speakers' Banquet & Birds of a Feather meeting",
         '',
         None,
         3,
         17.5,

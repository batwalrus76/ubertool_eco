...
# history
# http://www.reportlab.co.uk/cgi-bin/viewcvs.cgi/public/reportlab/trunk/reportlab/graphics/testshapes.py
...
def getDrawing06():
    ...
    D.add(
        Polygon([300, 20, 350, 20, 390, 80, 300, 75, 330, 40], fillColor=green))
...
def getDrawing13():
    ...
    def drawit(F, w=400, h=200, fontSize=12, slack=2, gap=5):
        ...
        for fontName in F:
            y -= th
            text = fontName + \
                asNative(b': I should be totally horizontal and enclosed in a box and end in alphabetagamma \xc2\xa2\xc2\xa9\xc2\xae\xc2\xa3\xca\xa5\xd0\x96\xd6\x83\xd7\x90\xd9\x82\xe0\xa6\x95\xce\xb1\xce\xb2\xce\xb3')
            textWidth = stringWidth(text, fontName, fontSize)

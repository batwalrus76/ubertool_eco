...
# set to 0 to die on too large elements in tables in debug (recommend 1
# for production use)
...
# produces repeatable,identical PDFs with same timestamp info (for
# regression testing)
invariant = 0
...
# default don't use Henning von Bargen's long table optimizations
longTableOptimize = 1
...
# if the bold/italic/bold italic fonts are also registered and defined as
# a family.

allowShortTableRows = 1  # allows some rows in a table to be short
# attempt to convert images into internal memory files to reduce
imageReaderFlags = 0
...
rtlSupport = 0
# set to 0/False to force platypus.flowables._listWrapOn to report correct
# widths

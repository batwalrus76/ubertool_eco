...
# history
# http://www.reportlab.co.uk/cgi-bin/viewcvs.cgi/public/reportlab/trunk/reportlab/pdfgen/pdfimages.py
__version__ = ''' $Id$ '''
__doc__ = """
...
class PDFImage:
    ...
    def cache_imagedata(self):
        ...
        cachedname = os.path.splitext(
            image)[0] + (rl_config.useA85 and '.a85' or '.bin')
    ...
    def drawInlineImage(self, canvas, preserveAspectRatio=False, anchor='sw'):
        ...
        x, y, self.width, self.height, scaled = aspectRatioFix(
            preserveAspectRatio, anchor, self.x, self.y, width, height, self.imgwidth, self.imgheight)

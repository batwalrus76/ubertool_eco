...
allowedTypeFaces = typeFaces_chs + \
    typeFaces_cht + typeFaces_jpn + typeFaces_kor
...
encodings_kor = [
    ...
    # Microsoft Code Page 949 (lfCharSet 0x81), KS X 1001:1992
    'KSCms-UHC-H',
...
encodings_chs = [
    ...
    # Microsoft Code Page 936 (lfCharSet 0x86), GBK character
    'GBK-EUC-H',
                        # set, GBK encoding
...
# this data was derived from the above width information and removes all
# dependency on CMAP files as long as we only use the unicode fonts.
widthsByUnichar = {}
widthsByUnichar["MSung-Light"] = {u' ': 250,
                                  u'$': 490,
                                  u'(': 240,
                                  u',': 250,
                                  u'0': 500,
                                  ...
                                  u'y': 458,
                                  u'}': 480}
widthsByUnichar["HeiseiKakuGo-W5"] = {u'\uff81': 500,
                                      u'\uff85': 500,
                                      u'\uff89': 500,
                                      u'\uff8d': 500,
                                      u'\uff91': 500,
                                      ...
                                      u'}': 449,
                                      u'\uff7f': 500}
widthsByUnichar["HYSMyeongJo-Medium"] = {u' ': 333,
                                         u'$': 625,
                                         u'(': 500,
                                         u',': 291,
                                         u'0': 625,
                                         ...
                                         u'y': 625,
                                         u'}': 583}
widthsByUnichar["STSong-Light"] = {u' ': 207,
                                   u'$': 462,
                                   u'(': 374,
                                   u',': 238,
                                   u'0': 462,
                                   ...
                                   u'y': 452,
                                   u'}': 370}
widthsByUnichar["HeiseiMin-W3"] = {u'\uff81': 500,
                                   u'\u0302': 333,
                                   u'\uff85': 500,
                                   u'\u0306': 333,
                                   u'\uff89': 500,
                                   ...
                                   u'\uff7f': 500,
                                   u'\xfe': 500}
widthsByUnichar["HYGothic-Medium"] = {u' ': 500,
                                      u'$': 500,
                                      u'(': 500,
                                      u',': 500,
                                      u'0': 500,
